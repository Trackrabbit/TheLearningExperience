...
--select max(Xfr_Record_Number) from cm20600
--exec DE_ICGLInsert 3397,'21023-00-00-00',-50.00,'68400-02-02-09',867
CREATE Proc [dbo].[DE_ICGLInsertTR] @JRNENTRY int,@xfrnumber numeric(19,5),@Src_ICAC Char(20),@AMT Numeric(19,5),@ICDestString char(20),@DestACINDX int
as
...
INSERT INTO [NCIC3006]
    ...
    -- VALUES
           ...
           '',
           0,
           0,--(Select top 1 SQNCLine from GL10001 je join GL00105 a on je.ACTINDX=a.ACTINDX where JRNENTRY=@JRNENTRY and  a.ACTNUMST=@Src_ICAC and (DEBITAMT-CRDTAMNT)=@AMT),
...
GO
GRANT EXECUTE ON  [dbo].[DE_ICGLInsertTR] TO [DYNGRP]
GO
