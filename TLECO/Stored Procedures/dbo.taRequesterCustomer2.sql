...
NULL as [Address!3!CUSTNMBR!element],
NULL as [Address!3!ADRSCODE!element],
NULL as [Address!3!SLPRSNID!element],
NULL as [Address!3!UPSZONE!element],
NULL as [Address!3!SHIPMTHD!element],
NULL as [Address!3!TAXSCHID!element],
NULL as [Address!3!CNTCPRSN!element],
...
NULL as [Address!3!GPSFOINTEGRATIONID!element],
NULL as [Address!3!INTEGRATIONSOURCE!element],
NULL as [Address!3!INTEGRATIONID!element],
NULL as [Internet_Address!4!Master_ID!element],
NULL as [Internet_Address!4!ADRSCODE!element],
NULL as [Internet_Address!4!Master_Type!element],
NULL as [Internet_Address!4!INET1!element],
NULL as [Internet_Address!4!INET2!element],
NULL as [Internet_Address!4!INET3!element],
NULL as [Internet_Address!4!INET4!element],
NULL as [Internet_Address!4!INET5!element],
NULL as [Internet_Address!4!INET6!element],
NULL as [Internet_Address!4!INET7!element],
NULL as [Internet_Address!4!INET8!element] FROM [#eConnect_Out] [eConnect] (nolock) 
...
RTRIM([Customer].ADDRESS1),RTRIM([Customer].ADDRESS2),RTRIM([Customer].ADDRESS3),RTRIM([Customer].ADRSCODE),RTRIM([Customer].CITY),RTRIM([Customer].CNTCPRSN),RTRIM([Customer].COUNTRY),RTRIM([Customer].CPRCSTNM),RTRIM([Customer].CURNCYID),RTRIM([Customer].CUSTCLAS),RTRIM([Customer].CUSTDISC),RTRIM([Customer].CUSTNAME),RTRIM([Customer].PHONE1),RTRIM([Customer].PHONE2),RTRIM([Customer].PHONE3),RTRIM([Customer].FAX),RTRIM([Customer].PYMTRMID),RTRIM([Customer].SALSTERR),RTRIM([Customer].SHIPMTHD),RTRIM([Customer].SLPRSNID),RTRIM([Customer].STATE),RTRIM([Customer].TAXSCHID),RTRIM([Customer].TXRGNNUM),RTRIM([Customer].UPSZONE),RTRIM([Customer].ZIP),RTRIM([Customer].STMTNAME),RTRIM([Customer].SHRTNAME),RTRIM([Customer].PRBTADCD),RTRIM([Customer].PRSTADCD),RTRIM([Customer].STADDRCD),RTRIM([Customer].CHEKBKID),RTRIM([Customer].CRLMTTYP),RTRIM([Customer].CRLMTAMT),RTRIM([Customer].CRLMTPER),RTRIM([Customer].CRLMTPAM),RTRIM([Customer].RATETPID),RTRIM([Customer].PRCLEVEL),RTRIM([Customer].MINPYTYP),RTRIM([Customer].MINPYDLR),RTRIM([Customer].MINPYPCT),RTRIM([Customer].FNCHATYP),RTRIM([Customer].FNCHPCNT),RTRIM([Customer].FINCHDLR),RTRIM([Customer].MXWOFTYP),RTRIM([Customer].MXWROFAM),RTRIM([Customer].COMMENT1),RTRIM([Customer].COMMENT2),RTRIM([Customer].USERDEF1),RTRIM([Customer].USERDEF2),RTRIM([Customer].TAXEXMT1),RTRIM([Customer].TAXEXMT2),RTRIM([Customer].BALNCTYP),RTRIM([Customer].STMTCYCL),RTRIM([Customer].BANKNAME),RTRIM([Customer].BNKBRNCH),[Customer].FRSTINDT,RTRIM([Customer].INACTIVE),RTRIM([Customer].HOLD),RTRIM([Customer].CRCARDID),RTRIM([Customer].CRCRDNUM),[Customer].CCRDXPDT,RTRIM([Customer].KPDSTHST),RTRIM([Customer].KPCALHST),RTRIM([Customer].KPERHIST),RTRIM([Customer].KPTRXHST),[Customer].CREATDDT,[Customer].MODIFDT,RTRIM([Customer].Revalue_Customer),RTRIM([Customer].Post_Results_To),RTRIM([Customer].FINCHID),RTRIM([Customer].GOVCRPID),RTRIM([Customer].GOVINDID),RTRIM([Customer].DISGRPER),RTRIM([Customer].DUEGRPER),RTRIM([Customer].DOCFMTID),RTRIM([Customer].Send_Email_Statements),RTRIM([Customer].GPSFOINTEGRATIONID),RTRIM([Customer].INTEGRATIONSOURCE),RTRIM([Customer].INTEGRATIONID),NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL FROM [#eConnect_Out] [eConnect] (nolock) 
...
eConnect.INDEX1,
LTRIM(RTRIM(Customer.CUSTNMBR)),
NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,LTRIM(RTRIM([Address].CUSTNMBR)),
LTRIM(RTRIM([Address].ADRSCODE)),
RTRIM([Address].SLPRSNID),RTRIM([Address].UPSZONE),RTRIM([Address].SHIPMTHD),RTRIM([Address].TAXSCHID),RTRIM([Address].CNTCPRSN),RTRIM([Address].ADDRESS1),RTRIM([Address].ADDRESS2),RTRIM([Address].ADDRESS3),RTRIM([Address].COUNTRY),RTRIM([Address].CITY),RTRIM([Address].STATE),RTRIM([Address].ZIP),RTRIM([Address].PHONE1),RTRIM([Address].PHONE2),RTRIM([Address].PHONE3),RTRIM([Address].FAX),RTRIM([Address].GPSFOINTEGRATIONID),RTRIM([Address].INTEGRATIONSOURCE),RTRIM([Address].INTEGRATIONID),NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL FROM [#eConnect_Out] [eConnect] (nolock) 
 left outer join [RM00101] [Customer] (nolock) on [Customer].CUSTNMBR = eConnect.INDEX1 left outer join [RM00102] [Address] (nolock) on Address.CUSTNMBR = Customer.CUSTNMBR UNION ALL Select 4,3,eConnect.ACTION,eConnect.DOCTYPE,
eConnect.DBNAME,
eConnect.TABLENAME,
eConnect.DATE1,
eConnect.INDEX1,
...
NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,LTRIM(RTRIM(Address.CUSTNMBR)),
LTRIM(RTRIM(Address.ADRSCODE)),
NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,LTRIM(RTRIM([Internet_Address].Master_ID)),
LTRIM(RTRIM([Internet_Address].ADRSCODE)),
RTRIM([Internet_Address].Master_Type),RTRIM([Internet_Address].INET1),RTRIM([Internet_Address].INET2),RTRIM([Internet_Address].INET3),RTRIM([Internet_Address].INET4),RTRIM([Internet_Address].INET5),RTRIM([Internet_Address].INET6),RTRIM([Internet_Address].INET7),RTRIM([Internet_Address].INET8) FROM [#eConnect_Out] [eConnect] (nolock) 
 left outer join [RM00101] [Customer] (nolock) on [Customer].CUSTNMBR = eConnect.INDEX1 left outer join [RM00102] [Address] (nolock) on Address.CUSTNMBR = Customer.CUSTNMBR left outer join [SY01200] [Internet_Address] (nolock) on Internet_Address.Master_ID = Address.CUSTNMBR and Internet_Address.ADRSCODE = Address.ADRSCODE Order by  [eConnect!1!CUSTNMBR],  [Customer!2!CUSTNMBR!element], [Address!3!CUSTNMBR!element], [Address!3!ADRSCODE!element],Tag,Parent FOR XML EXPLICIT, BINARY BASE64
GO
GRANT EXECUTE ON  [dbo].[taRequesterCustomer2] TO [DYNGRP]
GO
