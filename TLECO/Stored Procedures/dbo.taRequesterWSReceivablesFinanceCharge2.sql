...
NULL as [RECVDOCDIST!4!POSTED!element] FROM [#eConnect_Out] [eConnect] (nolock) 
...
LTRIM(RTRIM(RECVDOCHEADER.DOCNUMBR)),
LTRIM(RTRIM(RECVDOCHEADER.RMDTYPAL)),
NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,RTRIM([RECVDOCTAX].RMDTYPAL),RTRIM([RECVDOCTAX].DOCNUMBR),RTRIM([RECVDOCTAX].TAXDTLID),RTRIM([RECVDOCTAX].ACTNUMST),RTRIM([RECVDOCTAX].TAXAMNT),RTRIM([RECVDOCTAX].ORTAXAMT),RTRIM([RECVDOCTAX].STAXAMNT),RTRIM([RECVDOCTAX].ORSLSTAX),RTRIM([RECVDOCTAX].FRTTXAMT),RTRIM([RECVDOCTAX].ORFRTTAX),RTRIM([RECVDOCTAX].MSCTXAMT),RTRIM([RECVDOCTAX].ORMSCTAX),RTRIM([RECVDOCTAX].TAXDTSLS),RTRIM([RECVDOCTAX].ORTOTSLS),RTRIM([RECVDOCTAX].TDTTXSLS),RTRIM([RECVDOCTAX].ORTXSLS),RTRIM([RECVDOCTAX].BKOUTTAX),NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL FROM [#eConnect_Out] [eConnect] (nolock) 
...
LTRIM(RTRIM(RECVDOCHEADER.DOCNUMBR)),
LTRIM(RTRIM(RECVDOCHEADER.RMDTYPAL)),
NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,RTRIM([RECVDOCDIST].RMDTYPAL),RTRIM([RECVDOCDIST].DOCNUMBR),RTRIM([RECVDOCDIST].SEQNUMBR),RTRIM([RECVDOCDIST].DISTTYPE),RTRIM([RECVDOCDIST].DistRef),RTRIM([RECVDOCDIST].ACTNUMST),RTRIM([RECVDOCDIST].DEBITAMT),RTRIM([RECVDOCDIST].ORDBTAMT),RTRIM([RECVDOCDIST].CRDTAMNT),RTRIM([RECVDOCDIST].ORCRDAMT),RTRIM([RECVDOCDIST].POSTED) FROM [#eConnect_Out] [eConnect] (nolock) 
 left outer join [ReqRecvDocHeader] [RECVDOCHEADER] (nolock) on [RECVDOCHEADER].DOCNUMBR = eConnect.INDEX2 and [RECVDOCHEADER].RMDTYPAL = eConnect.INDEX3 left outer join [ReqRecvDocDist] [RECVDOCDIST] (nolock) on RECVDOCDIST.RMDTYPAL = RECVDOCHEADER.RMDTYPAL and RECVDOCDIST.DOCNUMBR = RECVDOCHEADER.DOCNUMBR Order by  [eConnect!1!TrxState],  [eConnect!1!DOCNUMBR],  [eConnect!1!RMDTYPAL],  [RECVDOCHEADER!2!TrxState!element], [RECVDOCHEADER!2!DOCNUMBR!element], [RECVDOCHEADER!2!RMDTYPAL!element],Tag,Parent FOR XML EXPLICIT, BINARY BASE64
GO
GRANT EXECUTE ON  [dbo].[taRequesterWSReceivablesFinanceCharge2] TO [DYNGRP]
GO
