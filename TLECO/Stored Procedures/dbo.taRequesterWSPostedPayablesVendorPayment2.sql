...
LTRIM(RTRIM(PAYABLESDOCUMENTHEADER.VCHRNMBR)),
LTRIM(RTRIM(PAYABLESDOCUMENTHEADER.DOCTYPE)),
NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,RTRIM([PAYABLESDOCUMENTTAX].TrxState),RTRIM([PAYABLESDOCUMENTTAX].VCHRNMBR),RTRIM([PAYABLESDOCUMENTTAX].TAXDTLID),RTRIM([PAYABLESDOCUMENTTAX].TAXAMNT),RTRIM([PAYABLESDOCUMENTTAX].ORTAXAMT),RTRIM([PAYABLESDOCUMENTTAX].PCTAXAMT),RTRIM([PAYABLESDOCUMENTTAX].ORPURTAX),RTRIM([PAYABLESDOCUMENTTAX].FRTTXAMT),RTRIM([PAYABLESDOCUMENTTAX].ORFRTTAX),RTRIM([PAYABLESDOCUMENTTAX].MSCTXAMT),RTRIM([PAYABLESDOCUMENTTAX].ORMSCTAX),RTRIM([PAYABLESDOCUMENTTAX].TDTTXPUR),RTRIM([PAYABLESDOCUMENTTAX].ORTXBPUR),RTRIM([PAYABLESDOCUMENTTAX].TXDTTPUR),RTRIM([PAYABLESDOCUMENTTAX].ORTOTPUR),RTRIM([PAYABLESDOCUMENTTAX].ACTNUMST),RTRIM([PAYABLESDOCUMENTTAX].BKOUTTAX),RTRIM([PAYABLESDOCUMENTTAX].POSTED),NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL FROM [#eConnect_Out] [eConnect] (nolock) 
...
LTRIM(RTRIM(PAYABLESDOCUMENTHEADER.VCHRNMBR)),
LTRIM(RTRIM(PAYABLESDOCUMENTHEADER.DOCTYPE)),
NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,RTRIM([PAYABLESDOCUMENTDIST].TrxState),RTRIM([PAYABLESDOCUMENTDIST].VCHRNMBR),RTRIM([PAYABLESDOCUMENTDIST].DSTSQNUM),RTRIM([PAYABLESDOCUMENTDIST].DISTTYPE),RTRIM([PAYABLESDOCUMENTDIST].DistRef),RTRIM([PAYABLESDOCUMENTDIST].ACTNUMST),RTRIM([PAYABLESDOCUMENTDIST].DEBITAMT),RTRIM([PAYABLESDOCUMENTDIST].CRDTAMNT),RTRIM([PAYABLESDOCUMENTDIST].ORDBTAMT),RTRIM([PAYABLESDOCUMENTDIST].ORCRDAMT),RTRIM([PAYABLESDOCUMENTDIST].INTERID),RTRIM([PAYABLESDOCUMENTDIST].PSTGSTUS),[PAYABLESDOCUMENTDIST].PSTGDATE FROM [#eConnect_Out] [eConnect] (nolock) 
...
GO
GRANT EXECUTE ON  [dbo].[taRequesterWSPostedPayablesVendorPayment2] TO [DYNGRP]
GO
