...
CREATE Proc [dbo].[DE_BR_InsertTrasLineICStep2] @AccountString char(30),@Debit Numeric(19,5),@Credit Numeric(19,5),@Distref char(30),@GLPost datetime,@tocheckbook char(20),
...
BEGIN DECLARE @num1 int EXEC zDP_CM20100SI @NxtNum, @NxtNum, 0, 1, @NTRXSNUM, @tocheckbook, 7, @CMXFRNUM, 0x00000000, @num1 OUT  END 
   ...
   BEGIN DECLARE @num3 int EXEC zDP_CM20400SI @NxtNum, 0, 1, @ToCBACTINDX, @Debit, @Credit, @Distref, @GLPost, @Credit, @Debit, @num3 OUT  END          
...
GO
GRANT EXECUTE ON  [dbo].[DE_BR_InsertTrasLineICStep2] TO [DYNGRP]
GO
