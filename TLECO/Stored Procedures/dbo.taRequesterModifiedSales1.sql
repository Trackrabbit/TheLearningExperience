...
NULL as [SOHeader!2!RETUDATE!element] FROM [#eConnect_Out] [eConnect] (nolock) 
...
RTRIM([SOHeader].DOCID),RTRIM([SOHeader].TAXSCHID),RTRIM([SOHeader].FRTSCHID),RTRIM([SOHeader].MSCSCHID),RTRIM([SOHeader].SHIPMTHD),RTRIM([SOHeader].TAXAMNT),RTRIM([SOHeader].ORTAXAMT),RTRIM([SOHeader].LOCNCODE),[SOHeader].DOCDATE,RTRIM([SOHeader].FRTAMNT),RTRIM([SOHeader].ORFRTAMT),RTRIM([SOHeader].MISCAMNT),RTRIM([SOHeader].ORMISCAMT),RTRIM([SOHeader].TRDISAMT),RTRIM([SOHeader].ORTDISAM),RTRIM([SOHeader].TRDISPCT),RTRIM([SOHeader].MRKDNAMT),RTRIM([SOHeader].ORMRKDAM),RTRIM([SOHeader].CUSTNMBR),RTRIM([SOHeader].CUSTNAME),RTRIM([SOHeader].CSTPONBR),RTRIM([SOHeader].ShipToName),RTRIM([SOHeader].ADDRESS1),RTRIM([SOHeader].ADDRESS2),RTRIM([SOHeader].ADDRESS3),RTRIM([SOHeader].CNTCPRSN),RTRIM([SOHeader].FAXNUMBR),RTRIM([SOHeader].CITY),RTRIM([SOHeader].STATE),RTRIM([SOHeader].ZIPCODE),RTRIM([SOHeader].COUNTRY),RTRIM([SOHeader].CCode),RTRIM([SOHeader].PHNUMBR1),RTRIM([SOHeader].PHNUMBR2),RTRIM([SOHeader].PHONE3),RTRIM([SOHeader].SUBTOTAL),RTRIM([SOHeader].ORSUBTOT),RTRIM([SOHeader].DOCAMNT),RTRIM([SOHeader].ORDOCAMT),RTRIM([SOHeader].PYMTRCVD),RTRIM([SOHeader].ORPMTRVD),RTRIM([SOHeader].DEPRECVD),RTRIM([SOHeader].ORDEPRVD),RTRIM([SOHeader].SALSTERR),RTRIM([SOHeader].SLPRSNID),RTRIM([SOHeader].UPSZONE),RTRIM([SOHeader].USER2ENT),[SOHeader].CREATDDT,[SOHeader].DEX_ROW_TS,RTRIM([SOHeader].BACHNUMB),RTRIM([SOHeader].BCHSOURC),RTRIM([SOHeader].PRBTADCD),RTRIM([SOHeader].PRSTADCD),RTRIM([SOHeader].FRTTXAMT),RTRIM([SOHeader].ORFRTTAX),RTRIM([SOHeader].MSCTXAMT),RTRIM([SOHeader].ORMSCTAX),RTRIM([SOHeader].MSTRNUMB),RTRIM([SOHeader].PYMTRMID),RTRIM([SOHeader].COMAPPTO),RTRIM([SOHeader].COMMAMNT),RTRIM([SOHeader].OCOMMAMT),RTRIM([SOHeader].CMMSLAMT),RTRIM([SOHeader].ORCOSAMT),RTRIM([SOHeader].CURNCYID),RTRIM([SOHeader].XCHGRATE),[SOHeader].EXCHDATE,RTRIM([SOHeader].FRGTTXBL),RTRIM([SOHeader].MISCTXBL),RTRIM([SOHeader].COMMNTID),[SOHeader].ReqShipDate,[SOHeader].ACTLSHIP,[SOHeader].FUFILDAT,[SOHeader].QUOEXPDA,[SOHeader].QUOTEDAT,RTRIM([SOHeader].PRCLEVEL),RTRIM([SOHeader].TAXEXMT1),RTRIM([SOHeader].TAXEXMT2),RTRIM([SOHeader].TXRGNNUM),RTRIM([SOHeader].TRXSORCE),RTRIM([SOHeader].ECTRX),RTRIM([SOHeader].VOIDSTTS),RTRIM([SOHeader].REFRENCE),RTRIM([SOHeader].SHIPCOMPLETE),RTRIM([SOHeader].DISTKNAM),RTRIM([SOHeader].ORDISTKN),[SOHeader].DUEDATE,[SOHeader].DISCDATE,RTRIM([SOHeader].DISAVAMT),RTRIM([SOHeader].ORDAVAMT),RTRIM([SOHeader].DSCDLRAM),RTRIM([SOHeader].ORDDLRAT),RTRIM([SOHeader].DSCPCTAM),[SOHeader].GLPOSTDT,[SOHeader].POSTEDDT,RTRIM([SOHeader].PTDUSRID),RTRIM([SOHeader].DIRECTDEBIT),RTRIM([SOHeader].GPSFOINTEGRATIONID),RTRIM([SOHeader].INTEGRATIONSOURCE),RTRIM([SOHeader].INTEGRATIONID),[SOHeader].INVODATE,[SOHeader].BACKDATE,[SOHeader].RETUDATE FROM [#eConnect_Out] [eConnect] (nolock) 
 left outer join [SOP10100] [SOHeader] (nolock) on [SOHeader].SOPNUMBE = eConnect.INDEX1 and [SOHeader].SOPTYPE = eConnect.INDEX2 Order by  [eConnect!1!SOPNUMBE],  [eConnect!1!SOPTYPE],  [SOHeader!2!SOPNUMBE!element], [SOHeader!2!SOPTYPE!element],Tag,Parent FOR XML EXPLICIT, BINARY BASE64
GO
GRANT EXECUTE ON  [dbo].[taRequesterModifiedSales1] TO [DYNGRP]
GO
