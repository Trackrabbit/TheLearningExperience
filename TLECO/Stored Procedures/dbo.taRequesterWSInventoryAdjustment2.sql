...
NULL as [IVADJUSTHEADER!2!TrxState!element],
NULL as [IVADJUSTHEADER!2!IVDOCNBR!element],
NULL as [IVADJUSTHEADER!2!IVDOCTYP!element],
NULL as [IVADJUSTHEADER!2!BACHNUMB!element],
NULL as [IVADJUSTHEADER!2!BCHSOURC!element],
NULL as [IVADJUSTHEADER!2!BatchCreatedDate!element],
NULL as [IVADJUSTHEADER!2!BatchCreatedTime!element],
NULL as [IVADJUSTHEADER!2!DOCDATE!element],
NULL as [IVADJUSTHEADER!2!CREATDDT!element],
NULL as [IVADJUSTHEADER!2!DEX_ROW_TS!element],
NULL as [IVADJUSTHEADER!2!TRXSORCE!element],
NULL as [IVADJUSTHEADER!2!GLPOSTDT!element],
NULL as [IVADJUSTLINE!3!TrxState!element],
NULL as [IVADJUSTLINE!3!IVDOCTYP!element],
NULL as [IVADJUSTLINE!3!IVDOCNBR!element],
NULL as [IVADJUSTLINE!3!LNSEQNBR!element],
NULL as [IVADJUSTLINE!3!ITEMNMBR!element],
NULL as [IVADJUSTLINE!3!UOFM!element],
NULL as [IVADJUSTLINE!3!TRXQTY!element],
NULL as [IVADJUSTLINE!3!UNITCOST!element],
NULL as [IVADJUSTLINE!3!TRXLOCTN!element],
NULL as [IVADJUSTLINE!3!InventoryAccount!element],
NULL as [IVADJUSTLINE!3!InventoryAccountOffset!element],
NULL as [IVADJUSTLINE!3!DECPLQTY!element],
NULL as [IVADJUSTLINE!3!DECPLCUR!element],
NULL as [IVADJLINEBINDETAIL!4!TrxState!element],
NULL as [IVADJLINEBINDETAIL!4!IVDOCNBR!element],
NULL as [IVADJLINEBINDETAIL!4!LNSEQNBR!element],
NULL as [IVADJLINEBINDETAIL!4!QUANTITY!element],
NULL as [IVADJLINEBINDETAIL!4!BIN!element],
NULL as [IVADJLINEBINDETAIL!4!SEQNUMBR!element],
NULL as [IVADJLINEBINDETAIL!4!IVDOCTYP!element],
NULL as [IVADJLINELOTDETAIL!5!TrxState!element],
NULL as [IVADJLINELOTDETAIL!5!IVDOCNBR!element],
NULL as [IVADJLINELOTDETAIL!5!SERLTNUM!element],
NULL as [IVADJLINELOTDETAIL!5!SERLTQTY!element],
NULL as [IVADJLINELOTDETAIL!5!FROMBIN!element],
NULL as [IVADJLINELOTDETAIL!5!LNSEQNBR!element],
NULL as [IVADJLINELOTDETAIL!5!SLTSQNUM!element],
NULL as [IVADJLINELOTDETAIL!5!MFGDATE!element],
NULL as [IVADJLINELOTDETAIL!5!EXPNDATE!element],
NULL as [IVADJLINELOTDETAIL!5!IVDOCTYP!element],
NULL as [IVADJLINELOTDETAIL!5!DATERECD!element],
NULL as [IVADJLINESERIALDETAIL!6!TrxState!element],
NULL as [IVADJLINESERIALDETAIL!6!IVDOCNBR!element],
NULL as [IVADJLINESERIALDETAIL!6!SERLTNUM!element],
NULL as [IVADJLINESERIALDETAIL!6!FROMBIN!element],
NULL as [IVADJLINESERIALDETAIL!6!LNSEQNBR!element],
NULL as [IVADJLINESERIALDETAIL!6!SLTSQNUM!element],
NULL as [IVADJLINESERIALDETAIL!6!IVDOCTYP!element] FROM [#eConnect_Out] [eConnect] (nolock) 
...
eConnect.INDEX2,
eConnect.INDEX3,
LTRIM(RTRIM([IVADJUSTHEADER].TrxState)),
LTRIM(RTRIM([IVADJUSTHEADER].IVDOCNBR)),
LTRIM(RTRIM([IVADJUSTHEADER].IVDOCTYP)),
RTRIM([IVADJUSTHEADER].BACHNUMB),RTRIM([IVADJUSTHEADER].BCHSOURC),[IVADJUSTHEADER].BatchCreatedDate,[IVADJUSTHEADER].BatchCreatedTime,[IVADJUSTHEADER].DOCDATE,RTRIM([IVADJUSTHEADER].CREATDDT),[IVADJUSTHEADER].DEX_ROW_TS,RTRIM([IVADJUSTHEADER].TRXSORCE),[IVADJUSTHEADER].GLPOSTDT,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL FROM [#eConnect_Out] [eConnect] (nolock) 
 left outer join [ReqIVHeaderView] [IVADJUSTHEADER] (nolock) on [IVADJUSTHEADER].IVDOCNBR = eConnect.INDEX2 and [IVADJUSTHEADER].IVDOCTYP = eConnect.INDEX3 UNION ALL Select 3,2,eConnect.ACTION,eConnect.DOCTYPE,
eConnect.DBNAME,
eConnect.TABLENAME,
eConnect.DATE1,
eConnect.INDEX1,
...
LTRIM(RTRIM(IVADJUSTHEADER.IVDOCNBR)),
LTRIM(RTRIM(IVADJUSTHEADER.IVDOCTYP)),
NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,LTRIM(RTRIM([IVADJUSTLINE].TrxState)),
LTRIM(RTRIM([IVADJUSTLINE].IVDOCTYP)),
LTRIM(RTRIM([IVADJUSTLINE].IVDOCNBR)),
LTRIM(RTRIM([IVADJUSTLINE].LNSEQNBR)),
RTRIM([IVADJUSTLINE].ITEMNMBR),RTRIM([IVADJUSTLINE].UOFM),RTRIM([IVADJUSTLINE].TRXQTY),RTRIM([IVADJUSTLINE].UNITCOST),RTRIM([IVADJUSTLINE].TRXLOCTN),RTRIM([IVADJUSTLINE].InventoryAccount),RTRIM([IVADJUSTLINE].InventoryAccountOffset),RTRIM([IVADJUSTLINE].DECPLQTY),RTRIM([IVADJUSTLINE].DECPLCUR),NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL FROM [#eConnect_Out] [eConnect] (nolock) 
 left outer join [ReqIVHeaderView] [IVADJUSTHEADER] (nolock) on [IVADJUSTHEADER].IVDOCNBR = eConnect.INDEX2 and [IVADJUSTHEADER].IVDOCTYP = eConnect.INDEX3 left outer join [ReqIVLineView] [IVADJUSTLINE] (nolock) on IVADJUSTLINE.IVDOCNBR = IVADJUSTHEADER.IVDOCNBR and IVADJUSTLINE.IVDOCTYP = IVADJUSTHEADER.IVDOCTYP UNION ALL Select 4,3,eConnect.ACTION,eConnect.DOCTYPE,
eConnect.DBNAME,
eConnect.TABLENAME,
eConnect.DATE1,
eConnect.INDEX1,
...
LTRIM(RTRIM(IVADJUSTLINE.IVDOCNBR)),
LTRIM(RTRIM(IVADJUSTLINE.LNSEQNBR)),
NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,RTRIM([IVADJLINEBINDETAIL].TrxState),RTRIM([IVADJLINEBINDETAIL].IVDOCNBR),RTRIM([IVADJLINEBINDETAIL].LNSEQNBR),RTRIM([IVADJLINEBINDETAIL].QUANTITY),RTRIM([IVADJLINEBINDETAIL].BIN),RTRIM([IVADJLINEBINDETAIL].SEQNUMBR),RTRIM([IVADJLINEBINDETAIL].IVDOCTYP),NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL FROM [#eConnect_Out] [eConnect] (nolock) 
 left outer join [ReqIVHeaderView] [IVADJUSTHEADER] (nolock) on [IVADJUSTHEADER].IVDOCNBR = eConnect.INDEX2 and [IVADJUSTHEADER].IVDOCTYP = eConnect.INDEX3 left outer join [ReqIVLineView] [IVADJUSTLINE] (nolock) on IVADJUSTLINE.IVDOCNBR = IVADJUSTHEADER.IVDOCNBR and IVADJUSTLINE.IVDOCTYP = IVADJUSTHEADER.IVDOCTYP left outer join [ReqIVLineBinDetailView] [IVADJLINEBINDETAIL] (nolock) on IVADJLINEBINDETAIL.IVDOCTYP = IVADJUSTLINE.IVDOCTYP and IVADJLINEBINDETAIL.IVDOCNBR = IVADJUSTLINE.IVDOCNBR and IVADJLINEBINDETAIL.LNSEQNBR = IVADJUSTLINE.LNSEQNBR UNION ALL Select 5,3,eConnect.ACTION,eConnect.DOCTYPE,
eConnect.DBNAME,
eConnect.TABLENAME,
eConnect.DATE1,
eConnect.INDEX1,
...
LTRIM(RTRIM(IVADJUSTLINE.IVDOCNBR)),
LTRIM(RTRIM(IVADJUSTLINE.LNSEQNBR)),
NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,RTRIM([IVADJLINELOTDETAIL].TrxState),RTRIM([IVADJLINELOTDETAIL].IVDOCNBR),RTRIM([IVADJLINELOTDETAIL].SERLTNUM),RTRIM([IVADJLINELOTDETAIL].SERLTQTY),RTRIM([IVADJLINELOTDETAIL].FROMBIN),RTRIM([IVADJLINELOTDETAIL].LNSEQNBR),RTRIM([IVADJLINELOTDETAIL].SLTSQNUM),[IVADJLINELOTDETAIL].MFGDATE,[IVADJLINELOTDETAIL].EXPNDATE,RTRIM([IVADJLINELOTDETAIL].IVDOCTYP),[IVADJLINELOTDETAIL].DATERECD,NULL,NULL,NULL,NULL,NULL,NULL,NULL FROM [#eConnect_Out] [eConnect] (nolock) 
 left outer join [ReqIVHeaderView] [IVADJUSTHEADER] (nolock) on [IVADJUSTHEADER].IVDOCNBR = eConnect.INDEX2 and [IVADJUSTHEADER].IVDOCTYP = eConnect.INDEX3 left outer join [ReqIVLineView] [IVADJUSTLINE] (nolock) on IVADJUSTLINE.IVDOCNBR = IVADJUSTHEADER.IVDOCNBR and IVADJUSTLINE.IVDOCTYP = IVADJUSTHEADER.IVDOCTYP left outer join [ReqIVLineLotDetailView] [IVADJLINELOTDETAIL] (nolock) on IVADJLINELOTDETAIL.IVDOCTYP = IVADJUSTLINE.IVDOCTYP and IVADJLINELOTDETAIL.IVDOCNBR = IVADJUSTLINE.IVDOCNBR and IVADJLINELOTDETAIL.LNSEQNBR = IVADJUSTLINE.LNSEQNBR UNION ALL Select 6,3,eConnect.ACTION,eConnect.DOCTYPE,
eConnect.DBNAME,
eConnect.TABLENAME,
eConnect.DATE1,
eConnect.INDEX1,
...
LTRIM(RTRIM(IVADJUSTLINE.IVDOCNBR)),
LTRIM(RTRIM(IVADJUSTLINE.LNSEQNBR)),
NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,RTRIM([IVADJLINESERIALDETAIL].TrxState),RTRIM([IVADJLINESERIALDETAIL].IVDOCNBR),RTRIM([IVADJLINESERIALDETAIL].SERLTNUM),RTRIM([IVADJLINESERIALDETAIL].FROMBIN),RTRIM([IVADJLINESERIALDETAIL].LNSEQNBR),RTRIM([IVADJLINESERIALDETAIL].SLTSQNUM),RTRIM([IVADJLINESERIALDETAIL].IVDOCTYP) FROM [#eConnect_Out] [eConnect] (nolock) 
 left outer join [ReqIVHeaderView] [IVADJUSTHEADER] (nolock) on [IVADJUSTHEADER].IVDOCNBR = eConnect.INDEX2 and [IVADJUSTHEADER].IVDOCTYP = eConnect.INDEX3 left outer join [ReqIVLineView] [IVADJUSTLINE] (nolock) on IVADJUSTLINE.IVDOCNBR = IVADJUSTHEADER.IVDOCNBR and IVADJUSTLINE.IVDOCTYP = IVADJUSTHEADER.IVDOCTYP left outer join [ReqIVLineSerialDetailView] [IVADJLINESERIALDETAIL] (nolock) on IVADJLINESERIALDETAIL.IVDOCTYP = IVADJUSTLINE.IVDOCTYP and IVADJLINESERIALDETAIL.IVDOCNBR = IVADJUSTLINE.IVDOCNBR and IVADJLINESERIALDETAIL.LNSEQNBR = IVADJUSTLINE.LNSEQNBR Order by  [eConnect!1!TrxState],  [eConnect!1!IVDOCNBR],  [eConnect!1!IVDOCTYP],  [IVADJUSTHEADER!2!TrxState!element], [IVADJUSTHEADER!2!IVDOCNBR!element], [IVADJUSTHEADER!2!IVDOCTYP!element], [IVADJUSTLINE!3!TrxState!element], [IVADJUSTLINE!3!IVDOCTYP!element], [IVADJUSTLINE!3!IVDOCNBR!element], [IVADJUSTLINE!3!LNSEQNBR!element],Tag,Parent FOR XML EXPLICIT, BINARY BASE64
GO
GRANT EXECUTE ON  [dbo].[taRequesterWSInventoryAdjustment2] TO [DYNGRP]
GO
