...
rtrim(cast(eConnect.INDEX2 as [char])) as [eConnect!1!IVDOCNBR],
cast(eConnect.INDEX3 as [smallint]) as [eConnect!1!IVDOCTYP],
NULL as [IVTRANSFERHEADER!2!TrxState!element],
NULL as [IVTRANSFERHEADER!2!IVDOCNBR!element],
NULL as [IVTRANSFERHEADER!2!IVDOCTYP!element],
NULL as [IVTRANSFERHEADER!2!BACHNUMB!element],
NULL as [IVTRANSFERHEADER!2!BCHSOURC!element],
NULL as [IVTRANSFERHEADER!2!BatchCreatedDate!element],
NULL as [IVTRANSFERHEADER!2!BatchCreatedTime!element],
NULL as [IVTRANSFERHEADER!2!DOCDATE!element],
NULL as [IVTRANSFERHEADER!2!CREATDDT!element],
NULL as [IVTRANSFERHEADER!2!DEX_ROW_TS!element],
NULL as [IVTRANSFERHEADER!2!TRXSORCE!element],
NULL as [IVTRANSFERHEADER!2!GLPOSTDT!element],
NULL as [IVTRANSFERLINE!3!TrxState!element],
NULL as [IVTRANSFERLINE!3!IVDOCTYP!element],
NULL as [IVTRANSFERLINE!3!IVDOCNBR!element],
NULL as [IVTRANSFERLINE!3!LNSEQNBR!element],
NULL as [IVTRANSFERLINE!3!ITEMNMBR!element],
NULL as [IVTRANSFERLINE!3!UOFM!element],
NULL as [IVTRANSFERLINE!3!TRXQTY!element],
NULL as [IVTRANSFERLINE!3!UNITCOST!element],
NULL as [IVTRANSFERLINE!3!TRXLOCTN!element],
NULL as [IVTRANSFERLINE!3!TRNSTLOC!element],
NULL as [IVTRANSFERLINE!3!TRFQTYTY!element],
NULL as [IVTRANSFERLINE!3!TRTQTYTY!element],
NULL as [IVTRANSFERLINE!3!InventoryAccount!element],
NULL as [IVTRANSFERLINE!3!InventoryAccountOffset!element],
NULL as [IVTRANSFERLINE!3!DECPLQTY!element],
NULL as [IVTRANSFERLINE!3!DECPLCUR!element],
NULL as [IVTRANSFERLINEBINDETAIL!4!TrxState!element],
NULL as [IVTRANSFERLINEBINDETAIL!4!IVDOCNBR!element],
NULL as [IVTRANSFERLINEBINDETAIL!4!LNSEQNBR!element],
NULL as [IVTRANSFERLINEBINDETAIL!4!QUANTITY!element],
NULL as [IVTRANSFERLINEBINDETAIL!4!BIN!element],
NULL as [IVTRANSFERLINEBINDETAIL!4!TOBIN!element],
NULL as [IVTRANSFERLINEBINDETAIL!4!SEQNUMBR!element],
NULL as [IVTRANSFERLINEBINDETAIL!4!IVDOCTYP!element],
NULL as [IVTRANSFERLINELOTDETAIL!5!TrxState!element],
NULL as [IVTRANSFERLINELOTDETAIL!5!IVDOCNBR!element],
NULL as [IVTRANSFERLINELOTDETAIL!5!SERLTNUM!element],
NULL as [IVTRANSFERLINELOTDETAIL!5!SERLTQTY!element],
NULL as [IVTRANSFERLINELOTDETAIL!5!FROMBIN!element],
NULL as [IVTRANSFERLINELOTDETAIL!5!TOBIN!element],
NULL as [IVTRANSFERLINELOTDETAIL!5!LNSEQNBR!element],
NULL as [IVTRANSFERLINELOTDETAIL!5!SLTSQNUM!element],
NULL as [IVTRANSFERLINELOTDETAIL!5!MFGDATE!element],
NULL as [IVTRANSFERLINELOTDETAIL!5!EXPNDATE!element],
NULL as [IVTRANSFERLINELOTDETAIL!5!IVDOCTYP!element],
NULL as [IVTRANSFERLINELOTDETAIL!5!DATERECD!element],
NULL as [IVTRANSFERLINESERIALDETAIL!6!TrxState!element],
NULL as [IVTRANSFERLINESERIALDETAIL!6!IVDOCNBR!element],
NULL as [IVTRANSFERLINESERIALDETAIL!6!SERLTNUM!element],
NULL as [IVTRANSFERLINESERIALDETAIL!6!FROMBIN!element],
NULL as [IVTRANSFERLINESERIALDETAIL!6!TOBIN!element],
NULL as [IVTRANSFERLINESERIALDETAIL!6!LNSEQNBR!element],
NULL as [IVTRANSFERLINESERIALDETAIL!6!SLTSQNUM!element],
NULL as [IVTRANSFERLINESERIALDETAIL!6!IVDOCTYP!element] FROM [#eConnect_Out] [eConnect] (nolock) 
...
eConnect.INDEX2,
eConnect.INDEX3,
LTRIM(RTRIM([IVTRANSFERHEADER].TrxState)),
LTRIM(RTRIM([IVTRANSFERHEADER].IVDOCNBR)),
LTRIM(RTRIM([IVTRANSFERHEADER].IVDOCTYP)),
RTRIM([IVTRANSFERHEADER].BACHNUMB),RTRIM([IVTRANSFERHEADER].BCHSOURC),[IVTRANSFERHEADER].BatchCreatedDate,[IVTRANSFERHEADER].BatchCreatedTime,[IVTRANSFERHEADER].DOCDATE,RTRIM([IVTRANSFERHEADER].CREATDDT),[IVTRANSFERHEADER].DEX_ROW_TS,RTRIM([IVTRANSFERHEADER].TRXSORCE),[IVTRANSFERHEADER].GLPOSTDT,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL FROM [#eConnect_Out] [eConnect] (nolock) 
 left outer join [ReqIVHeaderView] [IVTRANSFERHEADER] (nolock) on [IVTRANSFERHEADER].IVDOCNBR = eConnect.INDEX2 and [IVTRANSFERHEADER].IVDOCTYP = eConnect.INDEX3 UNION ALL Select 3,2,eConnect.ACTION,eConnect.DOCTYPE,
eConnect.DBNAME,
eConnect.TABLENAME,
eConnect.DATE1,
eConnect.INDEX1,
...
LTRIM(RTRIM(IVTRANSFERHEADER.IVDOCNBR)),
LTRIM(RTRIM(IVTRANSFERHEADER.IVDOCTYP)),
NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,LTRIM(RTRIM([IVTRANSFERLINE].TrxState)),
LTRIM(RTRIM([IVTRANSFERLINE].IVDOCTYP)),
LTRIM(RTRIM([IVTRANSFERLINE].IVDOCNBR)),
LTRIM(RTRIM([IVTRANSFERLINE].LNSEQNBR)),
RTRIM([IVTRANSFERLINE].ITEMNMBR),RTRIM([IVTRANSFERLINE].UOFM),RTRIM([IVTRANSFERLINE].TRXQTY),RTRIM([IVTRANSFERLINE].UNITCOST),RTRIM([IVTRANSFERLINE].TRXLOCTN),RTRIM([IVTRANSFERLINE].TRNSTLOC),RTRIM([IVTRANSFERLINE].TRFQTYTY),RTRIM([IVTRANSFERLINE].TRTQTYTY),RTRIM([IVTRANSFERLINE].InventoryAccount),RTRIM([IVTRANSFERLINE].InventoryAccountOffset),RTRIM([IVTRANSFERLINE].DECPLQTY),RTRIM([IVTRANSFERLINE].DECPLCUR),NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL FROM [#eConnect_Out] [eConnect] (nolock) 
 left outer join [ReqIVHeaderView] [IVTRANSFERHEADER] (nolock) on [IVTRANSFERHEADER].IVDOCNBR = eConnect.INDEX2 and [IVTRANSFERHEADER].IVDOCTYP = eConnect.INDEX3 left outer join [ReqIVLineView] [IVTRANSFERLINE] (nolock) on IVTRANSFERLINE.IVDOCNBR = IVTRANSFERHEADER.IVDOCNBR and IVTRANSFERLINE.IVDOCTYP = IVTRANSFERHEADER.IVDOCTYP UNION ALL Select 4,3,eConnect.ACTION,eConnect.DOCTYPE,
eConnect.DBNAME,
eConnect.TABLENAME,
eConnect.DATE1,
eConnect.INDEX1,
...
LTRIM(RTRIM(IVTRANSFERLINE.IVDOCNBR)),
LTRIM(RTRIM(IVTRANSFERLINE.LNSEQNBR)),
NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,RTRIM([IVTRANSFERLINEBINDETAIL].TrxState),RTRIM([IVTRANSFERLINEBINDETAIL].IVDOCNBR),RTRIM([IVTRANSFERLINEBINDETAIL].LNSEQNBR),RTRIM([IVTRANSFERLINEBINDETAIL].QUANTITY),RTRIM([IVTRANSFERLINEBINDETAIL].BIN),RTRIM([IVTRANSFERLINEBINDETAIL].TOBIN),RTRIM([IVTRANSFERLINEBINDETAIL].SEQNUMBR),RTRIM([IVTRANSFERLINEBINDETAIL].IVDOCTYP),NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL FROM [#eConnect_Out] [eConnect] (nolock) 
 left outer join [ReqIVHeaderView] [IVTRANSFERHEADER] (nolock) on [IVTRANSFERHEADER].IVDOCNBR = eConnect.INDEX2 and [IVTRANSFERHEADER].IVDOCTYP = eConnect.INDEX3 left outer join [ReqIVLineView] [IVTRANSFERLINE] (nolock) on IVTRANSFERLINE.IVDOCNBR = IVTRANSFERHEADER.IVDOCNBR and IVTRANSFERLINE.IVDOCTYP = IVTRANSFERHEADER.IVDOCTYP left outer join [ReqIVLineBinDetailView] [IVTRANSFERLINEBINDETAIL] (nolock) on IVTRANSFERLINEBINDETAIL.IVDOCTYP = IVTRANSFERLINE.IVDOCTYP and IVTRANSFERLINEBINDETAIL.IVDOCNBR = IVTRANSFERLINE.IVDOCNBR and IVTRANSFERLINEBINDETAIL.LNSEQNBR = IVTRANSFERLINE.LNSEQNBR UNION ALL Select 5,3,eConnect.ACTION,eConnect.DOCTYPE,
eConnect.DBNAME,
eConnect.TABLENAME,
eConnect.DATE1,
eConnect.INDEX1,
...
LTRIM(RTRIM(IVTRANSFERLINE.IVDOCNBR)),
LTRIM(RTRIM(IVTRANSFERLINE.LNSEQNBR)),
NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,RTRIM([IVTRANSFERLINELOTDETAIL].TrxState),RTRIM([IVTRANSFERLINELOTDETAIL].IVDOCNBR),RTRIM([IVTRANSFERLINELOTDETAIL].SERLTNUM),RTRIM([IVTRANSFERLINELOTDETAIL].SERLTQTY),RTRIM([IVTRANSFERLINELOTDETAIL].FROMBIN),RTRIM([IVTRANSFERLINELOTDETAIL].TOBIN),RTRIM([IVTRANSFERLINELOTDETAIL].LNSEQNBR),RTRIM([IVTRANSFERLINELOTDETAIL].SLTSQNUM),[IVTRANSFERLINELOTDETAIL].MFGDATE,[IVTRANSFERLINELOTDETAIL].EXPNDATE,RTRIM([IVTRANSFERLINELOTDETAIL].IVDOCTYP),[IVTRANSFERLINELOTDETAIL].DATERECD,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL FROM [#eConnect_Out] [eConnect] (nolock) 
 left outer join [ReqIVHeaderView] [IVTRANSFERHEADER] (nolock) on [IVTRANSFERHEADER].IVDOCNBR = eConnect.INDEX2 and [IVTRANSFERHEADER].IVDOCTYP = eConnect.INDEX3 left outer join [ReqIVLineView] [IVTRANSFERLINE] (nolock) on IVTRANSFERLINE.IVDOCNBR = IVTRANSFERHEADER.IVDOCNBR and IVTRANSFERLINE.IVDOCTYP = IVTRANSFERHEADER.IVDOCTYP left outer join [ReqIVLineLotDetailView] [IVTRANSFERLINELOTDETAIL] (nolock) on IVTRANSFERLINELOTDETAIL.IVDOCTYP = IVTRANSFERLINE.IVDOCTYP and IVTRANSFERLINELOTDETAIL.IVDOCNBR = IVTRANSFERLINE.IVDOCNBR and IVTRANSFERLINELOTDETAIL.LNSEQNBR = IVTRANSFERLINE.LNSEQNBR UNION ALL Select 6,3,eConnect.ACTION,eConnect.DOCTYPE,
eConnect.DBNAME,
eConnect.TABLENAME,
eConnect.DATE1,
eConnect.INDEX1,
...
LTRIM(RTRIM(IVTRANSFERLINE.IVDOCNBR)),
LTRIM(RTRIM(IVTRANSFERLINE.LNSEQNBR)),
NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,RTRIM([IVTRANSFERLINESERIALDETAIL].TrxState),RTRIM([IVTRANSFERLINESERIALDETAIL].IVDOCNBR),RTRIM([IVTRANSFERLINESERIALDETAIL].SERLTNUM),RTRIM([IVTRANSFERLINESERIALDETAIL].FROMBIN),RTRIM([IVTRANSFERLINESERIALDETAIL].TOBIN),RTRIM([IVTRANSFERLINESERIALDETAIL].LNSEQNBR),RTRIM([IVTRANSFERLINESERIALDETAIL].SLTSQNUM),RTRIM([IVTRANSFERLINESERIALDETAIL].IVDOCTYP) FROM [#eConnect_Out] [eConnect] (nolock) 
 left outer join [ReqIVHeaderView] [IVTRANSFERHEADER] (nolock) on [IVTRANSFERHEADER].IVDOCNBR = eConnect.INDEX2 and [IVTRANSFERHEADER].IVDOCTYP = eConnect.INDEX3 left outer join [ReqIVLineView] [IVTRANSFERLINE] (nolock) on IVTRANSFERLINE.IVDOCNBR = IVTRANSFERHEADER.IVDOCNBR and IVTRANSFERLINE.IVDOCTYP = IVTRANSFERHEADER.IVDOCTYP left outer join [ReqIVLineSerialDetailView] [IVTRANSFERLINESERIALDETAIL] (nolock) on IVTRANSFERLINESERIALDETAIL.IVDOCTYP = IVTRANSFERLINE.IVDOCTYP and IVTRANSFERLINESERIALDETAIL.IVDOCNBR = IVTRANSFERLINE.IVDOCNBR and IVTRANSFERLINESERIALDETAIL.LNSEQNBR = IVTRANSFERLINE.LNSEQNBR Order by  [eConnect!1!TrxState],  [eConnect!1!IVDOCNBR],  [eConnect!1!IVDOCTYP],  [IVTRANSFERHEADER!2!TrxState!element], [IVTRANSFERHEADER!2!IVDOCNBR!element], [IVTRANSFERHEADER!2!IVDOCTYP!element], [IVTRANSFERLINE!3!TrxState!element], [IVTRANSFERLINE!3!IVDOCTYP!element], [IVTRANSFERLINE!3!IVDOCNBR!element], [IVTRANSFERLINE!3!LNSEQNBR!element],Tag,Parent FOR XML EXPLICIT, BINARY BASE64
GO
GRANT EXECUTE ON  [dbo].[taRequesterWSInventoryTransfer2] TO [DYNGRP]
GO
