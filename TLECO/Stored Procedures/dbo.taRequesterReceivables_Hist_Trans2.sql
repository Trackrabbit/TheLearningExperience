...
RTRIM([Header].CPRCSTNM),RTRIM([Header].CHEKNMBR),RTRIM([Header].BACHNUMB),RTRIM([Header].BCHSOURC),RTRIM([Header].TRXSORCE),[Header].DUEDATE,[Header].DOCDATE,[Header].POSTDATE,RTRIM([Header].PSTUSRID),[Header].GLPOSTDT,[Header].LSTEDTDT,RTRIM([Header].LSTUSRED),RTRIM([Header].ORTRXAMT),RTRIM([Header].CURTRXAM),RTRIM([Header].SLSAMNT),RTRIM([Header].COSTAMNT),RTRIM([Header].FRTAMNT),RTRIM([Header].MISCAMNT),RTRIM([Header].TAXAMNT),RTRIM([Header].COMDLRAM),RTRIM([Header].CASHAMNT),RTRIM([Header].DISTKNAM),RTRIM([Header].DISAVAMT),RTRIM([Header].DISCRTND),[Header].DISCDATE,RTRIM([Header].DSCDLRAM),RTRIM([Header].DSCPCTAM),RTRIM([Header].WROFAMNT),RTRIM([Header].TRXDSCRN),RTRIM([Header].CSPORNBR),RTRIM([Header].SLPRSNID),RTRIM([Header].SLSTERCD),[Header].DINVPDOF,RTRIM([Header].PPSAMDED),RTRIM([Header].GSTDSAMT),RTRIM([Header].DELETE1),RTRIM([Header].VOIDSTTS),[Header].VOIDDATE,RTRIM([Header].TAXSCHID),RTRIM([Header].CURNCYID),RTRIM([Header].PYMTRMID),RTRIM([Header].SHIPMTHD),RTRIM([Header].TRDISAMT),RTRIM([Header].SLSCHDID),RTRIM([Header].FRTSCHID),RTRIM([Header].MSCSCHID),RTRIM([Header].NOTEINDX),[Header].Tax_Date,RTRIM([Header].APLYWITH),[Header].SALEDATE,RTRIM([Header].CORRCTN),RTRIM([Header].SIMPLIFD),RTRIM([Header].Electronic),RTRIM([Header].ECTRX),RTRIM([Header].BKTSLSAM),RTRIM([Header].BKTFRTAM),RTRIM([Header].BKTMSCAM),RTRIM([Header].BackoutTradeDisc),RTRIM([Header].Factoring),NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL FROM [#eConnect_Out] [eConnect] (nolock) 
 left outer join [RM30101] [Header] (nolock) on [Header].CUSTNMBR = eConnect.INDEX1 and [Header].RMDTYPAL = eConnect.INDEX2 and [Header].DOCNUMBR = eConnect.INDEX3 UNION ALL Select 3,2,eConnect.ACTION,eConnect.DOCTYPE,
eConnect.DBNAME,
eConnect.TABLENAME,
eConnect.DATE1,
eConnect.INDEX1,
