...
CREATE Proc [dbo].[DE_BR_InsertTrasLineIC] @AccountString char(30),@Debit Numeric(19,5),@Credit Numeric(19,5),@Distref char(30),@GLPost datetime,@tocheckbook char(20),
...
INSERT INTO [CM20400]
     ...
     VALUES
          ...
          create table ##dexInserted (Dex_row_id int)
...
GO
GRANT EXECUTE ON  [dbo].[DE_BR_InsertTrasLineIC] TO [DYNGRP]
GO
