...
rtrim(cast(eConnect.INDEX1 as [char])) as [eConnect!1!VCHNUMWK],
rtrim(cast(eConnect.INDEX2 as [char])) as [eConnect!1!BACHNUMB],
NULL as [PM_Trans!2!VCHNUMWK!element],
NULL as [PM_Trans!2!BACHNUMB!element],
NULL as [PM_Trans!2!BCHSOURC!element],
NULL as [PM_Trans!2!VENDORID!element],
NULL as [PM_Trans!2!DOCNUMBR!element],
NULL as [PM_Trans!2!DOCTYPE!element],
NULL as [PM_Trans!2!DOCAMNT!element],
NULL as [PM_Trans!2!DOCDATE!element],
NULL as [PM_Trans!2!PSTGDATE!element],
NULL as [PM_Trans!2!VADDCDPR!element],
NULL as [PM_Trans!2!PYMTRMID!element],
NULL as [PM_Trans!2!DUEDATE!element],
NULL as [PM_Trans!2!DSCDLRAM!element],
NULL as [PM_Trans!2!DISCDATE!element],
NULL as [PM_Trans!2!PRCHAMNT!element],
NULL as [PM_Trans!2!CHRGAMNT!element],
NULL as [PM_Trans!2!CASHAMNT!element],
NULL as [PM_Trans!2!CAMCBKID!element],
NULL as [PM_Trans!2!CDOCNMBR!element],
NULL as [PM_Trans!2!CAMTDATE!element],
NULL as [PM_Trans!2!CAMPMTNM!element],
NULL as [PM_Trans!2!CHEKAMNT!element],
NULL as [PM_Trans!2!CHAMCBID!element],
NULL as [PM_Trans!2!CHEKDATE!element],
NULL as [PM_Trans!2!CAMPYNBR!element],
NULL as [PM_Trans!2!CRCRDAMT!element],
NULL as [PM_Trans!2!CCAMPYNM!element],
NULL as [PM_Trans!2!CHEKNMBR!element],
NULL as [PM_Trans!2!CARDNAME!element],
NULL as [PM_Trans!2!CCRCTNUM!element],
NULL as [PM_Trans!2!CRCARDDT!element],
NULL as [PM_Trans!2!CHEKBKID!element],
NULL as [PM_Trans!2!TRXDSCRN!element],
NULL as [PM_Trans!2!TRDISAMT!element],
NULL as [PM_Trans!2!TAXAMNT!element],
NULL as [PM_Trans!2!FRTAMNT!element],
NULL as [PM_Trans!2!TEN99AMNT!element],
NULL as [PM_Trans!2!MSCCHAMT!element],
NULL as [PM_Trans!2!PORDNMBR!element],
NULL as [PM_Trans!2!SHIPMTHD!element],
NULL as [PM_Trans!2!DISAMTAV!element],
NULL as [PM_Trans!2!DISTKNAM!element],
NULL as [PM_Trans!2!APDSTKAM!element],
NULL as [PM_Trans!2!WROFAMNT!element],
NULL as [PM_Trans!2!MDFUSRID!element],
NULL as [PM_Trans!2!POSTEDDT!element],
NULL as [PM_Trans!2!PTDUSRID!element],
NULL as [PM_Trans!2!PCHSCHID!element],
NULL as [PM_Trans!2!FRTSCHID!element],
NULL as [PM_Trans!2!MSCSCHID!element],
NULL as [PM_Trans!2!PRCTDISC!element],
NULL as [PM_Trans!2!SOURCDOC!element],
NULL as [PM_Trans!2!TAXSCHID!element],
NULL as [PM_Trans!2!CURNCYID!element],
NULL as [PM_Trans!2!UN1099AM!element],
NULL as [PM_Trans!2!CURTRXAM!element],
NULL as [PM_Trans!2!TXENGCLD!element],
NULL as [PM_Trans!2!GSTDSAMT!element],
NULL as [PM_Trans!2!PGRAMSBJ!element],
NULL as [PM_Trans!2!PPSAMDED!element],
NULL as [PM_Trans!2!PPSTAXRT!element],
NULL as [PM_Trans!2!PSTGSTUS!element],
NULL as [PM_Trans!2!POSTED!element],
NULL as [PM_Trans!2!APPLDAMT!element],
NULL as [PM_Trans!2!VCHRNMBR!element],
NULL as [PM_Trans!2!CNTRLTYP!element],
NULL as [PM_Trans!2!MODIFDT!element],
NULL as [PM_Trans!2!NOTEINDX!element],
NULL as [PM_Trans!2!BKTFRTAM!element],
NULL as [PM_Trans!2!BKTMSCAM!element],
NULL as [PM_Trans!2!BKTPURAM!element],
NULL as [PM_Trans!2!PRINTED!element],
NULL as [PM_Trans!2!RETNAGAM!element],
NULL as [PM_Trans!2!ICTRX!element],
NULL as [PM_Trans!2!ICDISTS!element],
NULL as [PM_Trans!2!Tax_Date!element],
NULL as [PM_Trans!2!PRCHDATE!element],
NULL as [PM_Trans!2!CORRCTN!element],
NULL as [PM_Trans!2!SIMPLIFD!element],
NULL as [PM_Trans!2!CORRNXST!element],
NULL as [PM_Trans!2!VCHRNCOR!element],
NULL as [PM_Trans!2!BNKRCAMT!element],
NULL as [PM_Trans!2!APLYWITH!element],
NULL as [PM_Trans!2!Electronic!element],
NULL as [PM_Trans!2!ECTRX!element],
NULL as [PM_Trans!2!DocPrinted!element],
NULL as [PM_Trans!2!TaxInvReqd!element],
NULL as [PM_Trans!2!BackoutTradeDisc!element],
NULL as [Tax!3!VCHRNMBR!element],
NULL as [Tax!3!TRXSORCE!element],
NULL as [Tax!3!TAXDTLID!element],
NULL as [Tax!3!VENDORID!element],
NULL as [Tax!3!TRXSORCE!element],
NULL as [Tax!3!BACHNUMB!element],
NULL as [Tax!3!TAXAMNT!element],
NULL as [Tax!3!PCTAXAMT!element],
NULL as [Tax!3!FRTTXAMT!element],
NULL as [Tax!3!MSCTXAMT!element],
NULL as [Tax!3!TDTTXPUR!element],
NULL as [Tax!3!TXDTTPUR!element],
NULL as [Tax!3!TAXDTLID!element],
NULL as [Tax!3!BKOUTTAX!element],
NULL as [Tax!3!ORTAXAMT!element],
NULL as [Tax!3!ORPURTAX!element],
NULL as [Tax!3!ORFRTTAX!element],
NULL as [Tax!3!ORMSCTAX!element],
NULL as [Tax!3!ACTINDX!element],
NULL as [Tax!3!ORTXBPUR!element],
NULL as [Tax!3!ORTOTPUR!element],
NULL as [Tax!3!CURRNIDX!element] FROM [#eConnect_Out] [eConnect] (nolock) 
...
eConnect.INDEX1,
eConnect.INDEX2,
LTRIM(RTRIM([PM_Trans].VCHNUMWK)),
LTRIM(RTRIM([PM_Trans].BACHNUMB)),
RTRIM([PM_Trans].BCHSOURC),RTRIM([PM_Trans].VENDORID),RTRIM([PM_Trans].DOCNUMBR),RTRIM([PM_Trans].DOCTYPE),RTRIM([PM_Trans].DOCAMNT),[PM_Trans].DOCDATE,[PM_Trans].PSTGDATE,RTRIM([PM_Trans].VADDCDPR),RTRIM([PM_Trans].PYMTRMID),[PM_Trans].DUEDATE,RTRIM([PM_Trans].DSCDLRAM),[PM_Trans].DISCDATE,RTRIM([PM_Trans].PRCHAMNT),RTRIM([PM_Trans].CHRGAMNT),RTRIM([PM_Trans].CASHAMNT),RTRIM([PM_Trans].CAMCBKID),RTRIM([PM_Trans].CDOCNMBR),[PM_Trans].CAMTDATE,RTRIM([PM_Trans].CAMPMTNM),RTRIM([PM_Trans].CHEKAMNT),RTRIM([PM_Trans].CHAMCBID),[PM_Trans].CHEKDATE,RTRIM([PM_Trans].CAMPYNBR),RTRIM([PM_Trans].CRCRDAMT),RTRIM([PM_Trans].CCAMPYNM),RTRIM([PM_Trans].CHEKNMBR),RTRIM([PM_Trans].CARDNAME),RTRIM([PM_Trans].CCRCTNUM),[PM_Trans].CRCARDDT,RTRIM([PM_Trans].CHEKBKID),RTRIM([PM_Trans].TRXDSCRN),RTRIM([PM_Trans].TRDISAMT),RTRIM([PM_Trans].TAXAMNT),RTRIM([PM_Trans].FRTAMNT),RTRIM([PM_Trans].TEN99AMNT),RTRIM([PM_Trans].MSCCHAMT),RTRIM([PM_Trans].PORDNMBR),RTRIM([PM_Trans].SHIPMTHD),RTRIM([PM_Trans].DISAMTAV),RTRIM([PM_Trans].DISTKNAM),RTRIM([PM_Trans].APDSTKAM),RTRIM([PM_Trans].WROFAMNT),RTRIM([PM_Trans].MDFUSRID),[PM_Trans].POSTEDDT,RTRIM([PM_Trans].PTDUSRID),RTRIM([PM_Trans].PCHSCHID),RTRIM([PM_Trans].FRTSCHID),RTRIM([PM_Trans].MSCSCHID),RTRIM([PM_Trans].PRCTDISC),RTRIM([PM_Trans].SOURCDOC),RTRIM([PM_Trans].TAXSCHID),RTRIM([PM_Trans].CURNCYID),RTRIM([PM_Trans].UN1099AM),RTRIM([PM_Trans].CURTRXAM),RTRIM([PM_Trans].TXENGCLD),RTRIM([PM_Trans].GSTDSAMT),RTRIM([PM_Trans].PGRAMSBJ),RTRIM([PM_Trans].PPSAMDED),RTRIM([PM_Trans].PPSTAXRT),RTRIM([PM_Trans].PSTGSTUS),RTRIM([PM_Trans].POSTED),RTRIM([PM_Trans].APPLDAMT),RTRIM([PM_Trans].VCHRNMBR),RTRIM([PM_Trans].CNTRLTYP),[PM_Trans].MODIFDT,RTRIM([PM_Trans].NOTEINDX),RTRIM([PM_Trans].BKTFRTAM),RTRIM([PM_Trans].BKTMSCAM),RTRIM([PM_Trans].BKTPURAM),RTRIM([PM_Trans].PRINTED),RTRIM([PM_Trans].RETNAGAM),RTRIM([PM_Trans].ICTRX),RTRIM([PM_Trans].ICDISTS),[PM_Trans].Tax_Date,[PM_Trans].PRCHDATE,RTRIM([PM_Trans].CORRCTN),RTRIM([PM_Trans].SIMPLIFD),RTRIM([PM_Trans].CORRNXST),RTRIM([PM_Trans].VCHRNCOR),RTRIM([PM_Trans].BNKRCAMT),RTRIM([PM_Trans].APLYWITH),RTRIM([PM_Trans].Electronic),RTRIM([PM_Trans].ECTRX),RTRIM([PM_Trans].DocPrinted),RTRIM([PM_Trans].TaxInvReqd),RTRIM([PM_Trans].BackoutTradeDisc),NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL FROM [#eConnect_Out] [eConnect] (nolock) 
 left outer join [PM10000] [PM_Trans] (nolock) on [PM_Trans].VCHNUMWK = eConnect.INDEX1 and [PM_Trans].BACHNUMB = eConnect.INDEX2 UNION ALL Select 3,2,eConnect.ACTION,eConnect.DOCTYPE,
eConnect.DBNAME,
eConnect.TABLENAME,
eConnect.DATE1,
eConnect.INDEX1,
...
LTRIM(RTRIM(PM_Trans.VCHNUMWK)),
LTRIM(RTRIM(PM_Trans.BACHNUMB)),
NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,LTRIM(RTRIM([Tax].VCHRNMBR)),
LTRIM(RTRIM([Tax].TRXSORCE)),
LTRIM(RTRIM([Tax].TAXDTLID)),
RTRIM([Tax].VENDORID),RTRIM([Tax].TRXSORCE),RTRIM([Tax].BACHNUMB),RTRIM([Tax].TAXAMNT),RTRIM([Tax].PCTAXAMT),RTRIM([Tax].FRTTXAMT),RTRIM([Tax].MSCTXAMT),RTRIM([Tax].TDTTXPUR),RTRIM([Tax].TXDTTPUR),RTRIM([Tax].TAXDTLID),RTRIM([Tax].BKOUTTAX),RTRIM([Tax].ORTAXAMT),RTRIM([Tax].ORPURTAX),RTRIM([Tax].ORFRTTAX),RTRIM([Tax].ORMSCTAX),RTRIM([Tax].ACTINDX),RTRIM([Tax].ORTXBPUR),RTRIM([Tax].ORTOTPUR),RTRIM([Tax].CURRNIDX) FROM [#eConnect_Out] [eConnect] (nolock) 
 left outer join [PM10000] [PM_Trans] (nolock) on [PM_Trans].VCHNUMWK = eConnect.INDEX1 and [PM_Trans].BACHNUMB = eConnect.INDEX2 left outer join [PM10500] [Tax] (nolock) on Tax.VCHRNMBR = PM_Trans.VCHNUMWK and Tax.DOCTYPE = PM_Trans.DOCTYPE Order by  [eConnect!1!VCHNUMWK],  [eConnect!1!BACHNUMB],  [PM_Trans!2!VCHNUMWK!element], [PM_Trans!2!BACHNUMB!element],Tag,Parent FOR XML EXPLICIT, BINARY BASE64
GO
GRANT EXECUTE ON  [dbo].[taRequesterPayables_Transaction2] TO [DYNGRP]
GO
