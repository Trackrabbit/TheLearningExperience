...
CREATE Proc [dbo].[DE_ICGLInsertV1] @JRNENTRY int,@Src_ICAC Char(20),@AMT Numeric(19,5),@ICDestString char(20),@DestACINDX int,@Dex int
as
...
INSERT INTO [NCIC3006]
    ...
    -- VALUES
           ...
           '',
           0,
           (Select top 1 SQNCLine from GL10001 je join GL00105 a on je.ACTINDX=a.ACTINDX where je.DEX_ROW_ID=@Dex),
...
GO
GRANT EXECUTE ON  [dbo].[DE_ICGLInsertV1] TO [DYNGRP]
GO
