...
cast(eConnect.INDEX1 as [smallint]) as [eConnect!1!RMDTYPAL],
rtrim(cast(eConnect.INDEX2 as [char])) as [eConnect!1!RMDNUMWK],
NULL as [Header!2!RMDTYPAL!element],
NULL as [Header!2!RMDNUMWK!element],
NULL as [Header!2!DOCTYPE!element],
NULL as [Header!2!DOCNUMBR!element],
NULL as [Header!2!DOCPRFIX!element],
NULL as [Header!2!DOCDESCR!element],
NULL as [Header!2!DOCDATE!element],
NULL as [Header!2!BACHNUMB!element],
NULL as [Header!2!BCHSOURC!element],
NULL as [Header!2!NOTEINDX!element],
NULL as [Header!2!CUSTNMBR!element],
NULL as [Header!2!CUSTNAME!element],
NULL as [Header!2!ADRSCODE!element],
NULL as [Header!2!SLPRSNID!element],
NULL as [Header!2!SALSTERR!element],
NULL as [Header!2!COMAPPTO!element],
NULL as [Header!2!COMDLRAM!element],
NULL as [Header!2!NCOMAMNT!element],
NULL as [Header!2!SHIPMTHD!element],
NULL as [Header!2!CSTPONBR!element],
NULL as [Header!2!TAXSCHID!element],
NULL as [Header!2!SLSCHDID!element],
NULL as [Header!2!FRTSCHID!element],
NULL as [Header!2!MSCSCHID!element],
NULL as [Header!2!COSTAMNT!element],
NULL as [Header!2!SLSAMNT!element],
NULL as [Header!2!TRDISAMT!element],
NULL as [Header!2!TRDDISCT!element],
NULL as [Header!2!FRTAMNT!element],
NULL as [Header!2!MISCAMNT!element],
NULL as [Header!2!TAXAMNT!element],
NULL as [Header!2!BKTSLSAM!element],
NULL as [Header!2!BKTFRTAM!element],
NULL as [Header!2!BKTMSCAM!element],
NULL as [Header!2!TXENGCLD!element],
NULL as [Header!2!DOCAMNT!element],
NULL as [Header!2!APPLDAMT!element],
NULL as [Header!2!CASHAMNT!element],
NULL as [Header!2!CBKIDCSH!element],
NULL as [Header!2!CASHDATE!element],
NULL as [Header!2!DCNUMCSH!element],
NULL as [Header!2!CHEKAMNT!element],
NULL as [Header!2!CBKIDCHK!element],
NULL as [Header!2!CBKIDCRD!element],
NULL as [Header!2!CHEKNMBR!element],
NULL as [Header!2!CHEKDATE!element],
NULL as [Header!2!DCNUMCHK!element],
NULL as [Header!2!CRCRDAMT!element],
NULL as [Header!2!CRCRDNAM!element],
NULL as [Header!2!RCTNCCRD!element],
NULL as [Header!2!CRCARDDT!element],
NULL as [Header!2!DCNUMCRD!element],
NULL as [Header!2!DISCRTND!element],
NULL as [Header!2!DISTKNAM!element],
NULL as [Header!2!DISAVTKN!element],
NULL as [Header!2!WROFAMNT!element],
NULL as [Header!2!PPSAMDED!element],
NULL as [Header!2!GSTDSAMT!element],
NULL as [Header!2!ACCTAMNT!element],
NULL as [Header!2!PYMTRMID!element],
NULL as [Header!2!DISAVAMT!element],
...
NULL as [Header!2!POSTED!element],
NULL as [Header!2!GLPOSTDT!element],
NULL as [Header!2!APLYWITH!element],
NULL as [Header!2!SALEDATE!element],
NULL as [Header!2!PSTGSTUS!element],
NULL as [Header!2!POSTEDDT!element],
NULL as [Header!2!PTDUSRID!element],
NULL as [Header!2!Tax_Date!element],
NULL as [Header!2!APLYWITH!element],
NULL as [Header!2!SALEDATE!element],
NULL as [Header!2!CORRCTN!element],
NULL as [Header!2!SIMPLIFD!element],
NULL as [Header!2!CORRNXST!element],
NULL as [Header!2!DOCNCORR!element],
NULL as [Header!2!DocPrinted!element],
NULL as [Header!2!DISGRPER!element],
NULL as [Header!2!DUEGRPER!element],
NULL as [Header!2!Electronic!element],
NULL as [Header!2!ECTRX!element],
NULL as [Header!2!PSTGSTUS!element],
NULL as [Header!2!BackoutTradeDisc!element],
NULL as [Invoice_Tax!3!RMDTYPAL!element],
NULL as [Invoice_Tax!3!DOCNUMBR!element],
NULL as [Invoice_Tax!3!TRXSORCE!element],
NULL as [Invoice_Tax!3!TAXDTLID!element],
NULL as [Invoice_Tax!3!BACHNUMB!element],
NULL as [Invoice_Tax!3!CUSTNMBR!element],
NULL as [Invoice_Tax!3!ACTINDX!element],
NULL as [Invoice_Tax!3!BKOUTTAX!element],
NULL as [Invoice_Tax!3!TAXAMNT!element],
NULL as [Invoice_Tax!3!ORTAXAMT!element],
NULL as [Invoice_Tax!3!STAXAMNT!element],
NULL as [Invoice_Tax!3!ORSLSTAX!element],
NULL as [Invoice_Tax!3!FRTTXAMT!element],
NULL as [Invoice_Tax!3!ORFRTTAX!element],
NULL as [Invoice_Tax!3!MSCTXAMT!element],
NULL as [Invoice_Tax!3!ORMSCTAX!element],
NULL as [Invoice_Tax!3!TAXDTSLS!element],
NULL as [Invoice_Tax!3!ORTOTSLS!element],
NULL as [Invoice_Tax!3!TDTTXSLS!element],
NULL as [Invoice_Tax!3!ORTXSLS!element],
NULL as [Invoice_Tax!3!POSTED!element],
NULL as [Invoice_Tax!3!SEQNUMBR!element],
NULL as [Invoice_Tax!3!CURRNIDX!element] FROM [#eConnect_Out] [eConnect] (nolock) 
...
eConnect.INDEX1,
eConnect.INDEX2,
LTRIM(RTRIM([Header].RMDTYPAL)),
LTRIM(RTRIM([Header].RMDNUMWK)),
RTRIM([Header].DOCTYPE),RTRIM([Header].DOCNUMBR),RTRIM([Header].DOCPRFIX),RTRIM([Header].DOCDESCR),[Header].DOCDATE,RTRIM([Header].BACHNUMB),RTRIM([Header].BCHSOURC),RTRIM([Header].NOTEINDX),RTRIM([Header].CUSTNMBR),RTRIM([Header].CUSTNAME),RTRIM([Header].ADRSCODE),RTRIM([Header].SLPRSNID),RTRIM([Header].SALSTERR),RTRIM([Header].COMAPPTO),RTRIM([Header].COMDLRAM),RTRIM([Header].NCOMAMNT),RTRIM([Header].SHIPMTHD),RTRIM([Header].CSTPONBR),RTRIM([Header].TAXSCHID),RTRIM([Header].SLSCHDID),RTRIM([Header].FRTSCHID),RTRIM([Header].MSCSCHID),RTRIM([Header].COSTAMNT),RTRIM([Header].SLSAMNT),RTRIM([Header].TRDISAMT),RTRIM([Header].TRDDISCT),RTRIM([Header].FRTAMNT),RTRIM([Header].MISCAMNT),RTRIM([Header].TAXAMNT),RTRIM([Header].BKTSLSAM),RTRIM([Header].BKTFRTAM),RTRIM([Header].BKTMSCAM),RTRIM([Header].TXENGCLD),RTRIM([Header].DOCAMNT),RTRIM([Header].APPLDAMT),RTRIM([Header].CASHAMNT),RTRIM([Header].CBKIDCSH),[Header].CASHDATE,RTRIM([Header].DCNUMCSH),RTRIM([Header].CHEKAMNT),RTRIM([Header].CBKIDCHK),RTRIM([Header].CBKIDCRD),RTRIM([Header].CHEKNMBR),[Header].CHEKDATE,RTRIM([Header].DCNUMCHK),RTRIM([Header].CRCRDAMT),RTRIM([Header].CRCRDNAM),RTRIM([Header].RCTNCCRD),[Header].CRCARDDT,RTRIM([Header].DCNUMCRD),RTRIM([Header].DISCRTND),RTRIM([Header].DISTKNAM),RTRIM([Header].DISAVTKN),RTRIM([Header].WROFAMNT),RTRIM([Header].PPSAMDED),RTRIM([Header].GSTDSAMT),RTRIM([Header].ACCTAMNT),RTRIM([Header].PYMTRMID),RTRIM([Header].DISAVAMT),[Header].DISCDATE,[Header].DUEDATE,RTRIM([Header].DSCDLRAM),RTRIM([Header].DSCPCTAM),RTRIM([Header].CURNCYID),RTRIM([Header].POSTED),[Header].GLPOSTDT,RTRIM([Header].APLYWITH),[Header].SALEDATE,RTRIM([Header].PSTGSTUS),[Header].POSTEDDT,RTRIM([Header].PTDUSRID),[Header].Tax_Date,RTRIM([Header].APLYWITH),[Header].SALEDATE,RTRIM([Header].CORRCTN),RTRIM([Header].SIMPLIFD),RTRIM([Header].CORRNXST),RTRIM([Header].DOCNCORR),RTRIM([Header].DocPrinted),RTRIM([Header].DISGRPER),RTRIM([Header].DUEGRPER),RTRIM([Header].Electronic),RTRIM([Header].ECTRX),RTRIM([Header].PSTGSTUS),RTRIM([Header].BackoutTradeDisc),NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL FROM [#eConnect_Out] [eConnect] (nolock) 
 left outer join [RM10301] [Header] (nolock) on [Header].RMDTYPAL = eConnect.INDEX1 and [Header].RMDNUMWK = eConnect.INDEX2 UNION ALL Select 3,2,eConnect.ACTION,eConnect.DOCTYPE,
eConnect.DBNAME,
eConnect.TABLENAME,
eConnect.DATE1,
eConnect.INDEX1,
...
LTRIM(RTRIM(Header.RMDTYPAL)),
LTRIM(RTRIM(Header.RMDNUMWK)),
NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,LTRIM(RTRIM([Invoice_Tax].RMDTYPAL)),
LTRIM(RTRIM([Invoice_Tax].DOCNUMBR)),
LTRIM(RTRIM([Invoice_Tax].TRXSORCE)),
LTRIM(RTRIM([Invoice_Tax].TAXDTLID)),
RTRIM([Invoice_Tax].BACHNUMB),RTRIM([Invoice_Tax].CUSTNMBR),RTRIM([Invoice_Tax].ACTINDX),RTRIM([Invoice_Tax].BKOUTTAX),RTRIM([Invoice_Tax].TAXAMNT),RTRIM([Invoice_Tax].ORTAXAMT),RTRIM([Invoice_Tax].STAXAMNT),RTRIM([Invoice_Tax].ORSLSTAX),RTRIM([Invoice_Tax].FRTTXAMT),RTRIM([Invoice_Tax].ORFRTTAX),RTRIM([Invoice_Tax].MSCTXAMT),RTRIM([Invoice_Tax].ORMSCTAX),RTRIM([Invoice_Tax].TAXDTSLS),RTRIM([Invoice_Tax].ORTOTSLS),RTRIM([Invoice_Tax].TDTTXSLS),RTRIM([Invoice_Tax].ORTXSLS),RTRIM([Invoice_Tax].POSTED),RTRIM([Invoice_Tax].SEQNUMBR),RTRIM([Invoice_Tax].CURRNIDX) FROM [#eConnect_Out] [eConnect] (nolock) 
 left outer join [RM10301] [Header] (nolock) on [Header].RMDTYPAL = eConnect.INDEX1 and [Header].RMDNUMWK = eConnect.INDEX2 left outer join [RM10601] [Invoice_Tax] (nolock) on Invoice_Tax.RMDTYPAL = Header.RMDTYPAL and Invoice_Tax.DOCNUMBR = Header.DOCNUMBR Order by  [eConnect!1!RMDTYPAL],  [eConnect!1!RMDNUMWK],  [Header!2!RMDTYPAL!element], [Header!2!RMDNUMWK!element],Tag,Parent FOR XML EXPLICIT, BINARY BASE64
GO
GRANT EXECUTE ON  [dbo].[taRequesterReceivables_Transaction2] TO [DYNGRP]
GO
