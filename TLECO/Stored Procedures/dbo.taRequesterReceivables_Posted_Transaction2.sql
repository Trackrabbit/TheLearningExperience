...
cast(eConnect.INDEX2 as [smallint]) as [eConnect!1!RMDTYPAL],
rtrim(cast(eConnect.INDEX3 as [char])) as [eConnect!1!DOCNUMBR],
NULL as [Header!2!CUSTNMBR!element],
NULL as [Header!2!RMDTYPAL!element],
NULL as [Header!2!DOCNUMBR!element],
NULL as [Header!2!CPRCSTNM!element],
NULL as [Header!2!CHEKNMBR!element],
NULL as [Header!2!BACHNUMB!element],
NULL as [Header!2!BCHSOURC!element],
NULL as [Header!2!TRXSORCE!element],
NULL as [Header!2!CSHRCTYP!element],
...
NULL as [Header!2!POSTDATE!element],
NULL as [Header!2!PSTUSRID!element],
NULL as [Header!2!GLPOSTDT!element],
NULL as [Header!2!LSTEDTDT!element],
NULL as [Header!2!LSTUSRED!element],
NULL as [Header!2!ORTRXAMT!element],
NULL as [Header!2!CURTRXAM!element],
...
NULL as [Header!2!TRXDSCRN!element],
NULL as [Header!2!CSPORNBR!element],
NULL as [Header!2!SLPRSNID!element],
NULL as [Header!2!SLSTERCD!element],
NULL as [Header!2!DINVPDOF!element],
NULL as [Header!2!PPSAMDED!element],
NULL as [Header!2!GSTDSAMT!element],
NULL as [Header!2!DELETE1!element],
NULL as [Header!2!AGNGBUKT!element],
NULL as [Header!2!VOIDSTTS!element],
NULL as [Header!2!VOIDDATE!element],
...
NULL as [Header!2!Factoring!element],
...
eConnect.INDEX2,
eConnect.INDEX3,
LTRIM(RTRIM([Header].CUSTNMBR)),
LTRIM(RTRIM([Header].RMDTYPAL)),
LTRIM(RTRIM([Header].DOCNUMBR)),
RTRIM([Header].CPRCSTNM),RTRIM([Header].CHEKNMBR),RTRIM([Header].BACHNUMB),RTRIM([Header].BCHSOURC),RTRIM([Header].TRXSORCE),RTRIM([Header].CSHRCTYP),RTRIM([Header].CBKIDCRD),RTRIM([Header].CBKIDCSH),RTRIM([Header].CBKIDCHK),[Header].DUEDATE,[Header].DOCDATE,[Header].POSTDATE,RTRIM([Header].PSTUSRID),[Header].GLPOSTDT,[Header].LSTEDTDT,RTRIM([Header].LSTUSRED),RTRIM([Header].ORTRXAMT),RTRIM([Header].CURTRXAM),RTRIM([Header].SLSAMNT),RTRIM([Header].COSTAMNT),RTRIM([Header].FRTAMNT),RTRIM([Header].MISCAMNT),RTRIM([Header].TAXAMNT),RTRIM([Header].COMDLRAM),RTRIM([Header].CASHAMNT),RTRIM([Header].DISTKNAM),RTRIM([Header].DISAVAMT),RTRIM([Header].DISAVTKN),RTRIM([Header].DISCRTND),[Header].DISCDATE,RTRIM([Header].DSCDLRAM),RTRIM([Header].DSCPCTAM),RTRIM([Header].WROFAMNT),RTRIM([Header].TRXDSCRN),RTRIM([Header].CSPORNBR),RTRIM([Header].SLPRSNID),RTRIM([Header].SLSTERCD),[Header].DINVPDOF,RTRIM([Header].PPSAMDED),RTRIM([Header].GSTDSAMT),RTRIM([Header].DELETE1),RTRIM([Header].AGNGBUKT),RTRIM([Header].VOIDSTTS),[Header].VOIDDATE,RTRIM([Header].TAXSCHID),RTRIM([Header].CURNCYID),RTRIM([Header].PYMTRMID),RTRIM([Header].SHIPMTHD),RTRIM([Header].TRDISAMT),RTRIM([Header].SLSCHDID),RTRIM([Header].FRTSCHID),RTRIM([Header].MSCSCHID),RTRIM([Header].NOTEINDX),[Header].Tax_Date,RTRIM([Header].APLYWITH),[Header].SALEDATE,RTRIM([Header].CORRCTN),RTRIM([Header].SIMPLIFD),RTRIM([Header].Electronic),RTRIM([Header].ECTRX),RTRIM([Header].BKTSLSAM),RTRIM([Header].BKTFRTAM),RTRIM([Header].BKTMSCAM),RTRIM([Header].BackoutTradeDisc),RTRIM([Header].Factoring),NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL FROM [#eConnect_Out] [eConnect] (nolock) 
 left outer join [RM20101] [Header] (nolock) on [Header].CUSTNMBR = eConnect.INDEX1 and [Header].RMDTYPAL = eConnect.INDEX2 and [Header].DOCNUMBR = eConnect.INDEX3 UNION ALL Select 3,2,eConnect.ACTION,eConnect.DOCTYPE,
eConnect.DBNAME,
eConnect.TABLENAME,
eConnect.DATE1,
eConnect.INDEX1,
...
LTRIM(RTRIM(Header.RMDTYPAL)),
LTRIM(RTRIM(Header.DOCNUMBR)),
NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,LTRIM(RTRIM([Invoice_Tax].RMDTYPAL)),
LTRIM(RTRIM([Invoice_Tax].DOCNUMBR)),
LTRIM(RTRIM([Invoice_Tax].TRXSORCE)),
LTRIM(RTRIM([Invoice_Tax].TAXDTLID)),
RTRIM([Invoice_Tax].BACHNUMB),RTRIM([Invoice_Tax].ACTINDX),RTRIM([Invoice_Tax].BKOUTTAX),RTRIM([Invoice_Tax].TAXAMNT),RTRIM([Invoice_Tax].ORTAXAMT),RTRIM([Invoice_Tax].STAXAMNT),RTRIM([Invoice_Tax].ORSLSTAX),RTRIM([Invoice_Tax].FRTTXAMT),RTRIM([Invoice_Tax].ORFRTTAX),RTRIM([Invoice_Tax].MSCTXAMT),RTRIM([Invoice_Tax].ORMSCTAX),RTRIM([Invoice_Tax].TAXDTSLS),RTRIM([Invoice_Tax].ORTOTSLS),RTRIM([Invoice_Tax].TDTTXSLS),RTRIM([Invoice_Tax].ORTXSLS),RTRIM([Invoice_Tax].POSTED),RTRIM([Invoice_Tax].SEQNUMBR),RTRIM([Invoice_Tax].CURRNIDX) FROM [#eConnect_Out] [eConnect] (nolock) 
 left outer join [RM20101] [Header] (nolock) on [Header].CUSTNMBR = eConnect.INDEX1 and [Header].RMDTYPAL = eConnect.INDEX2 and [Header].DOCNUMBR = eConnect.INDEX3 left outer join [RM10601] [Invoice_Tax] (nolock) on Invoice_Tax.RMDTYPAL = Header.RMDTYPAL and Invoice_Tax.DOCNUMBR = Header.DOCNUMBR and Invoice_Tax.CUSTNMBR = Header.CUSTNMBR Order by  [eConnect!1!CUSTNMBR],  [eConnect!1!RMDTYPAL],  [eConnect!1!DOCNUMBR],  [Header!2!CUSTNMBR!element], [Header!2!RMDTYPAL!element], [Header!2!DOCNUMBR!element],Tag,Parent FOR XML EXPLICIT, BINARY BASE64
GO
GRANT EXECUTE ON  [dbo].[taRequesterReceivables_Posted_Transaction2] TO [DYNGRP]
GO
