...
-- 
-- ============================================= 
CREATE PROCEDURE [dbo].[ws_delete_WSPolicyBehaviorSelectionParameter] 
( 
...
DECLARE @ROWCOUNT_VAR INT 
   ...
   DELETE FROM dbo.WSPolicyBehaviorSelectionParameter 
   WHERE 
   ...
   [SelectedBehaviorOptionId] = case when @SelectedBehaviorOptionId IS NULL then [SelectedBehaviorOptionId] else @SelectedBehaviorOptionId end AND 
...
ELSE 
   ...
   END 
GO
GRANT EXECUTE ON  [dbo].[ws_delete_WSPolicyBehaviorSelectionParameter] TO [DYNGRP]
GO
