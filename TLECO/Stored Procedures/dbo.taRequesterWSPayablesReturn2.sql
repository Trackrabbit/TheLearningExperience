...
NULL as [PAYABLESDOCUMENTHEADER!2!OTOTPAY!element],
NULL as [PAYABLESDOCUMENTTAX!3!TrxState!element],
NULL as [PAYABLESDOCUMENTTAX!3!VCHRNMBR!element],
NULL as [PAYABLESDOCUMENTTAX!3!TAXDTLID!element],
NULL as [PAYABLESDOCUMENTTAX!3!TAXAMNT!element],
NULL as [PAYABLESDOCUMENTTAX!3!ORTAXAMT!element],
NULL as [PAYABLESDOCUMENTTAX!3!PCTAXAMT!element],
NULL as [PAYABLESDOCUMENTTAX!3!ORPURTAX!element],
NULL as [PAYABLESDOCUMENTTAX!3!FRTTXAMT!element],
NULL as [PAYABLESDOCUMENTTAX!3!ORFRTTAX!element],
NULL as [PAYABLESDOCUMENTTAX!3!MSCTXAMT!element],
NULL as [PAYABLESDOCUMENTTAX!3!ORMSCTAX!element],
NULL as [PAYABLESDOCUMENTTAX!3!TDTTXPUR!element],
NULL as [PAYABLESDOCUMENTTAX!3!ORTXBPUR!element],
NULL as [PAYABLESDOCUMENTTAX!3!TXDTTPUR!element],
NULL as [PAYABLESDOCUMENTTAX!3!ORTOTPUR!element],
NULL as [PAYABLESDOCUMENTTAX!3!ACTNUMST!element],
NULL as [PAYABLESDOCUMENTTAX!3!BKOUTTAX!element],
NULL as [PAYABLESDOCUMENTTAX!3!POSTED!element],
NULL as [PAYABLESDOCUMENTDIST!4!TrxState!element],
NULL as [PAYABLESDOCUMENTDIST!4!VCHRNMBR!element],
NULL as [PAYABLESDOCUMENTDIST!4!DSTSQNUM!element],
NULL as [PAYABLESDOCUMENTDIST!4!DISTTYPE!element],
NULL as [PAYABLESDOCUMENTDIST!4!DistRef!element],
NULL as [PAYABLESDOCUMENTDIST!4!ACTNUMST!element],
NULL as [PAYABLESDOCUMENTDIST!4!DEBITAMT!element],
NULL as [PAYABLESDOCUMENTDIST!4!CRDTAMNT!element],
NULL as [PAYABLESDOCUMENTDIST!4!ORDBTAMT!element],
NULL as [PAYABLESDOCUMENTDIST!4!ORCRDAMT!element],
NULL as [PAYABLESDOCUMENTDIST!4!INTERID!element],
NULL as [PAYABLESDOCUMENTDIST!4!PSTGSTUS!element],
NULL as [PAYABLESDOCUMENTDIST!4!PSTGDATE!element] FROM [#eConnect_Out] [eConnect] (nolock) 
...
LTRIM(RTRIM(PAYABLESDOCUMENTHEADER.VCHRNMBR)),
LTRIM(RTRIM(PAYABLESDOCUMENTHEADER.DOCTYPE)),
NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,RTRIM([PAYABLESDOCUMENTTAX].TrxState),RTRIM([PAYABLESDOCUMENTTAX].VCHRNMBR),RTRIM([PAYABLESDOCUMENTTAX].TAXDTLID),RTRIM([PAYABLESDOCUMENTTAX].TAXAMNT),RTRIM([PAYABLESDOCUMENTTAX].ORTAXAMT),RTRIM([PAYABLESDOCUMENTTAX].PCTAXAMT),RTRIM([PAYABLESDOCUMENTTAX].ORPURTAX),RTRIM([PAYABLESDOCUMENTTAX].FRTTXAMT),RTRIM([PAYABLESDOCUMENTTAX].ORFRTTAX),RTRIM([PAYABLESDOCUMENTTAX].MSCTXAMT),RTRIM([PAYABLESDOCUMENTTAX].ORMSCTAX),RTRIM([PAYABLESDOCUMENTTAX].TDTTXPUR),RTRIM([PAYABLESDOCUMENTTAX].ORTXBPUR),RTRIM([PAYABLESDOCUMENTTAX].TXDTTPUR),RTRIM([PAYABLESDOCUMENTTAX].ORTOTPUR),RTRIM([PAYABLESDOCUMENTTAX].ACTNUMST),RTRIM([PAYABLESDOCUMENTTAX].BKOUTTAX),RTRIM([PAYABLESDOCUMENTTAX].POSTED),NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL FROM [#eConnect_Out] [eConnect] (nolock) 
 left outer join [ReqPMHeaderView] [PAYABLESDOCUMENTHEADER] (nolock) on [PAYABLESDOCUMENTHEADER].VCHRNMBR = eConnect.INDEX2 and [PAYABLESDOCUMENTHEADER].DOCTYPE = eConnect.INDEX3 left outer join [ReqPMHeaderTaxView] [PAYABLESDOCUMENTTAX] (nolock) on PAYABLESDOCUMENTTAX.VCHRNMBR = PAYABLESDOCUMENTHEADER.VCHRNMBR UNION ALL Select 4,2,eConnect.ACTION,eConnect.DOCTYPE,
eConnect.DBNAME,
eConnect.TABLENAME,
eConnect.DATE1,
eConnect.INDEX1,
...
LTRIM(RTRIM(PAYABLESDOCUMENTHEADER.VCHRNMBR)),
LTRIM(RTRIM(PAYABLESDOCUMENTHEADER.DOCTYPE)),
NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,RTRIM([PAYABLESDOCUMENTDIST].TrxState),RTRIM([PAYABLESDOCUMENTDIST].VCHRNMBR),RTRIM([PAYABLESDOCUMENTDIST].DSTSQNUM),RTRIM([PAYABLESDOCUMENTDIST].DISTTYPE),RTRIM([PAYABLESDOCUMENTDIST].DistRef),RTRIM([PAYABLESDOCUMENTDIST].ACTNUMST),RTRIM([PAYABLESDOCUMENTDIST].DEBITAMT),RTRIM([PAYABLESDOCUMENTDIST].CRDTAMNT),RTRIM([PAYABLESDOCUMENTDIST].ORDBTAMT),RTRIM([PAYABLESDOCUMENTDIST].ORCRDAMT),RTRIM([PAYABLESDOCUMENTDIST].INTERID),RTRIM([PAYABLESDOCUMENTDIST].PSTGSTUS),[PAYABLESDOCUMENTDIST].PSTGDATE FROM [#eConnect_Out] [eConnect] (nolock) 
 left outer join [ReqPMHeaderView] [PAYABLESDOCUMENTHEADER] (nolock) on [PAYABLESDOCUMENTHEADER].VCHRNMBR = eConnect.INDEX2 and [PAYABLESDOCUMENTHEADER].DOCTYPE = eConnect.INDEX3 left outer join [ReqPMHeaderDistView] [PAYABLESDOCUMENTDIST] (nolock) on PAYABLESDOCUMENTDIST.VCHRNMBR = PAYABLESDOCUMENTHEADER.VCHRNMBR Order by  [eConnect!1!TrxState],  [eConnect!1!VCHRNMBR],  [eConnect!1!DOCTYPE],  [PAYABLESDOCUMENTHEADER!2!TrxState!element], [PAYABLESDOCUMENTHEADER!2!VCHRNMBR!element], [PAYABLESDOCUMENTHEADER!2!DOCTYPE!element],Tag,Parent FOR XML EXPLICIT, BINARY BASE64
GO
GRANT EXECUTE ON  [dbo].[taRequesterWSPayablesReturn2] TO [DYNGRP]
GO
