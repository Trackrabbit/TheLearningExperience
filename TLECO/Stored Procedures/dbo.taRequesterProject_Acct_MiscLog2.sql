...
rtrim(eConnect.INDEX1) as [eConnect!1!PAMISCLDOCNO],
NULL as [PA_MiscLog!2!PAMISCLDOCNO!element],
NULL as [PA_MiscLog!2!PSMISCLTRXTYPE!element],
NULL as [PA_MiscLog!2!PADOCDT!element],
NULL as [PA_MiscLog!2!PAYR!element],
NULL as [PA_MiscLog!2!USERID!element],
NULL as [PA_MiscLog!2!BACHNUMB!element],
NULL as [PA_MiscLog!2!BCHSOURC!element],
NULL as [PA_MiscLog!2!TRXSORCE!element],
NULL as [PA_MiscLog!2!PAREFNO!element],
NULL as [PA_MiscLog!2!PSMISCID!element],
NULL as [PA_MiscLog!2!PAREPD!element],
NULL as [PA_MiscLog!2!PAREPDT!element],
NULL as [PA_MiscLog!2!PAPeriodEndDate!element],
NULL as [PA_MiscLog!2!PACOMM!element],
NULL as [PA_MiscLog!2!PAUD1!element],
NULL as [PA_MiscLog!2!PAUD2!element],
NULL as [PA_MiscLog!2!PATQTY!element],
NULL as [PA_MiscLog!2!PAtotcosts!element],
NULL as [PA_MiscLog!2!PATACRV!element],
NULL as [PA_MiscLog!2!NOTEINDX!element],
NULL as [PA_MiscLog!2!PAreptsuff!element],
NULL as [PA_MiscLog!2!PAPD!element],
NULL as [PA_MiscLog!2!LNITMSEQ!element],
NULL as [PA_MiscLog!2!CURNCYID!element],
NULL as [PA_MiscLog!2!CURRNIDX!element],
NULL as [PA_MiscLog!2!RATETPID!element],
NULL as [PA_MiscLog!2!EXGTBLID!element],
NULL as [PA_MiscLog!2!XCHGRATE!element],
NULL as [PA_MiscLog!2!EXCHDATE!element],
NULL as [PA_MiscLog!2!TIME1!element],
NULL as [PA_MiscLog!2!RTCLCMTD!element],
NULL as [PA_MiscLog!2!DENXRATE!element],
NULL as [PA_MiscLog!2!MCTRXSTT!element],
NULL as [PA_MiscLog!2!PAORIGTOTCOSTS!element],
NULL as [PA_MiscLog!2!PAORIACCRREV!element],
NULL as [Line!3!PAMISCLDOCNO!element],
NULL as [Line!3!LNITMSEQ!element],
NULL as [Line!3!PSMISCLTRXTYPE!element],
NULL as [Line!3!PAREFNO!element],
NULL as [Line!3!PSMISCID!element],
...
eConnect.DATE1,
eConnect.INDEX1,
LTRIM(RTRIM([PA_MiscLog].PAMISCLDOCNO)),
RTRIM([PA_MiscLog].PSMISCLTRXTYPE),RTRIM([PA_MiscLog].PADOCDT),RTRIM([PA_MiscLog].PAYR),RTRIM([PA_MiscLog].USERID),RTRIM([PA_MiscLog].BACHNUMB),RTRIM([PA_MiscLog].BCHSOURC),RTRIM([PA_MiscLog].TRXSORCE),RTRIM([PA_MiscLog].PAREFNO),RTRIM([PA_MiscLog].PSMISCID),RTRIM([PA_MiscLog].PAREPD),RTRIM([PA_MiscLog].PAREPDT),RTRIM([PA_MiscLog].PAPeriodEndDate),RTRIM([PA_MiscLog].PACOMM),RTRIM([PA_MiscLog].PAUD1),RTRIM([PA_MiscLog].PAUD2),RTRIM([PA_MiscLog].PATQTY),RTRIM([PA_MiscLog].PAtotcosts),RTRIM([PA_MiscLog].PATACRV),RTRIM([PA_MiscLog].NOTEINDX),RTRIM([PA_MiscLog].PAreptsuff),RTRIM([PA_MiscLog].PAPD),RTRIM([PA_MiscLog].LNITMSEQ),RTRIM([PA_MiscLog].CURNCYID),RTRIM([PA_MiscLog].CURRNIDX),RTRIM([PA_MiscLog].RATETPID),RTRIM([PA_MiscLog].EXGTBLID),RTRIM([PA_MiscLog].XCHGRATE),RTRIM([PA_MiscLog].EXCHDATE),RTRIM([PA_MiscLog].TIME1),RTRIM([PA_MiscLog].RTCLCMTD),RTRIM([PA_MiscLog].DENXRATE),RTRIM([PA_MiscLog].MCTRXSTT),RTRIM([PA_MiscLog].PAORIGTOTCOSTS),RTRIM([PA_MiscLog].PAORIACCRREV),NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL FROM [#eConnect_Out] [eConnect] (nolock) 
 left outer join [PA10200] [PA_MiscLog] (nolock) on [PA_MiscLog].PAMISCLDOCNO = eConnect.INDEX1 UNION ALL Select 3,2,eConnect.ACTION,eConnect.DOCTYPE,
eConnect.DBNAME,
eConnect.TABLENAME,
eConnect.DATE1,
eConnect.INDEX1,
LTRIM(RTRIM(PA_MiscLog.PAMISCLDOCNO)),
NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,LTRIM(RTRIM([Line].PAMISCLDOCNO)),
LTRIM(RTRIM([Line].LNITMSEQ)),
RTRIM([Line].PSMISCLTRXTYPE),RTRIM([Line].PAREFNO),RTRIM([Line].PSMISCID),RTRIM([Line].PADT),RTRIM([Line].PAPROJNUMBER),RTRIM([Line].PACOSTCATID),RTRIM([Line].PAQtyQ),RTRIM([Line].PABase_Qty),RTRIM([Line].PAUnit_of_Measure),RTRIM([Line].UOMSCHDL),RTRIM([Line].PAROUNDAMT),RTRIM([Line].PAUNITCOST),RTRIM([Line].ORUNTCST),RTRIM([Line].PABase_Unit_Cost),RTRIM([Line].PAORGBSUNITCST),RTRIM([Line].PAEXTCOST),RTRIM([Line].OREXTCST),RTRIM([Line].PATOTCST),RTRIM([Line].PAORIGTOTCOST),RTRIM([Line].PAOverhead_Amount),RTRIM([Line].PABaseOvhdCost),RTRIM([Line].PAORIGOVHDAMT),RTRIM([Line].PAORIGBASEOVRHCST),RTRIM([Line].PAOverheaPercentage),RTRIM([Line].PATOTALOVERH),RTRIM([Line].PAORIGTOTOVRHD),RTRIM([Line].PABILRATE),RTRIM([Line].PAORIGBILLRATE),RTRIM([Line].PA_Base_Billing_Rate),RTRIM([Line].PAORIGBSBILLRTE),RTRIM([Line].PAMARKPERCENT),RTRIM([Line].PAACREV),RTRIM([Line].PAORIACCRREV),RTRIM([Line].PASTD_Qty),RTRIM([Line].PANC_Qty),RTRIM([Line].PANB_Qty),RTRIM([Line].PAReference_Line_Seq_N),RTRIM([Line].PAbillnoteidx),RTRIM([Line].PAbllngtype),RTRIM([Line].PACONTNUMBER),RTRIM([Line].PAProfitType),RTRIM([Line].PAProfitPercent),RTRIM([Line].PAProfitAmount),RTRIM([Line].PAORIGPROFAMT),RTRIM([Line].PATotalProfit),RTRIM([Line].PAORIGTOTPROF),RTRIM([Line].PAexptdate),RTRIM([Line].PAApproved_Quantity),RTRIM([Line].PAAPPROVBILLRATE),RTRIM([Line].PAAPPROVMKUPPCT),RTRIM([Line].PAApproved_Billing_Amou),RTRIM([Line].PABilledProfitPercentage),RTRIM([Line].PA_Billed_Profit_Amount_),RTRIM([Line].PABilled_Amount),RTRIM([Line].PABilledTax),RTRIM([Line].PABilled_Misc),RTRIM([Line].PABilled_Freight),RTRIM([Line].PABilled_Discount),RTRIM([Line].PAWrite_UpDown_Amount),RTRIM([Line].PAWrite_UpDown_Percenta),RTRIM([Line].PAApprover_ID),RTRIM([Line].PABilled_QtyN),RTRIM([Line].PAApprover_Type),RTRIM([Line].PAPartial_Bill),RTRIM([Line].PABilling_StatusN),RTRIM([Line].PACGBWIPIDX),RTRIM([Line].PAUnbilled_AR_Idx),RTRIM([Line].PACogs_Idx),RTRIM([Line].PAContra_Account_IDX),RTRIM([Line].PAOverhead_IDX),RTRIM([Line].PAUnbilled_Proj_Rev_Idx),RTRIM([Line].RNDDIFF),RTRIM([Line].PACHGORDNO) FROM [#eConnect_Out] [eConnect] (nolock) 
 left outer join [PA10200] [PA_MiscLog] (nolock) on [PA_MiscLog].PAMISCLDOCNO = eConnect.INDEX1 left outer join [PA10201] [Line] (nolock) on Line.PAMISCLDOCNO = PA_MiscLog.PAMISCLDOCNO Order by  [eConnect!1!PAMISCLDOCNO],  [PA_MiscLog!2!PAMISCLDOCNO!element],Tag,Parent FOR XML EXPLICIT, BINARY BASE64
GO
GRANT EXECUTE ON  [dbo].[taRequesterProject_Acct_MiscLog2] TO [DYNGRP]
GO
