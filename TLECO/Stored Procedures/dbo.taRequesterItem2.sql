...
NULL as [Item!2!ITEMNMBR!element],
NULL as [Item!2!ITEMDESC!element],
NULL as [Item!2!LOCNCODE!element],
NULL as [Item!2!ITMSHNAM!element],
NULL as [Item!2!ITEMTYPE!element],
NULL as [Item!2!ITMGEDSC!element],
NULL as [Item!2!ITMCLSCD!element],
NULL as [Item!2!STNDCOST!element],
NULL as [Item!2!CURRCOST!element],
NULL as [Item!2!ITEMSHWT!element],
NULL as [Item!2!USCATVLS_1!element],
NULL as [Item!2!USCATVLS_2!element],
NULL as [Item!2!USCATVLS_3!element],
NULL as [Item!2!USCATVLS_4!element],
NULL as [Item!2!USCATVLS_5!element],
NULL as [Item!2!USCATVLS_6!element],
NULL as [Item!2!ALTITEM1!element],
NULL as [Item!2!ALTITEM2!element],
NULL as [Item!2!WRNTYDYS!element],
NULL as [Item!2!ITEMCODE!element],
NULL as [Item!2!PRCHSUOM!element],
NULL as [Item!2!SELNGUOM!element],
NULL as [Item!2!KTACCTSR!element],
NULL as [Item!2!LASTGENSN!element],
NULL as [Item!2!ABCCODE!element],
NULL as [Item!2!NOTEINDX!element],
NULL as [Item!2!DECPLQTY!element],
NULL as [Item!2!DECPLCUR!element],
NULL as [Item!2!ITMTSHID!element],
NULL as [Item!2!TAXOPTNS!element],
NULL as [Item!2!IVIVINDX!element],
NULL as [Item!2!IVIVOFIX!element],
NULL as [Item!2!IVCOGSIX!element],
NULL as [Item!2!IVSLSIDX!element],
NULL as [Item!2!IVSLDSIX!element],
NULL as [Item!2!IVSLRNIX!element],
NULL as [Item!2!IVINUSIX!element],
NULL as [Item!2!IVINSVIX!element],
NULL as [Item!2!IVDMGIDX!element],
NULL as [Item!2!IVVARIDX!element],
NULL as [Item!2!DPSHPIDX!element],
NULL as [Item!2!PURPVIDX!element],
NULL as [Item!2!UPPVIDX!element],
NULL as [Item!2!IVRETIDX!element],
NULL as [Item!2!ASMVRIDX!element],
NULL as [Item!2!ITMTRKOP!element],
NULL as [Item!2!LOTTYPE!element],
NULL as [Item!2!KPERHIST!element],
NULL as [Item!2!KPTRXHST!element],
NULL as [Item!2!KPCALHST!element],
NULL as [Item!2!KPDSTHST!element],
NULL as [Item!2!ALWBKORD!element],
NULL as [Item!2!VCTNMTHD!element],
NULL as [Item!2!UOMSCHDL!element],
NULL as [Item!2!MSTRCDTY!element],
NULL as [Item!2!MODIFDT!element],
NULL as [Item!2!CREATDDT!element],
NULL as [Item!2!PRCLEVEL!element],
NULL as [Item!2!PINFLIDX!element],
NULL as [Item!2!PURMCIDX!element],
NULL as [Item!2!IVINFIDX!element],
NULL as [Item!2!INVMCIDX!element],
NULL as [Item!2!CGSINFLX!element],
NULL as [Item!2!CGSMCIDX!element],
NULL as [Item!2!TCC!element],
NULL as [Item!2!PriceGroup!element],
NULL as [Item!2!PRICMTHD!element],
NULL as [Item!2!Revalue_Inventory!element],
NULL as [Item!2!Tolerance_Percentage!element],
NULL as [Item!2!Purchase_Item_Tax_Schedu!element],
NULL as [Item!2!Purchase_Tax_Options!element],
NULL as [Item!2!ITMPLNNNGTYP!element],
NULL as [Item!2!STTSTCLVLPRCNTG!element],
NULL as [Item!2!CNTRYORGN!element],
NULL as [Quantities!3!ITEMNMBR!element],
NULL as [Quantities!3!RCRDTYPE!element],
NULL as [Quantities!3!LOCNCODE!element],
NULL as [Quantities!3!PRIMVNDR!element],
NULL as [Quantities!3!BGNGQTY!element],
NULL as [Quantities!3!LSORDQTY!element],
NULL as [Quantities!3!LRCPTQTY!element],
NULL as [Quantities!3!LSTORDDT!element],
NULL as [Quantities!3!LSORDVND!element],
NULL as [Quantities!3!QTYONORD!element],
NULL as [Quantities!3!QTYBKORD!element],
NULL as [Quantities!3!QTY_Drop_Shipped!element],
NULL as [Quantities!3!QTYINUSE!element],
NULL as [Quantities!3!QTYINSVC!element],
NULL as [Quantities!3!QTYRTRND!element],
NULL as [Quantities!3!QTYDMGED!element],
NULL as [Quantities!3!QTYONHND!element],
NULL as [Quantities!3!ATYALLOC!element],
NULL as [Quantities!3!QTYCOMTD!element],
NULL as [Quantities!3!QTYSOLD!element],
NULL as [Quantities!3!BINNMBR!element],
NULL as [Quantities!3!ITMFRFLG!element],
NULL as [Quantities!3!LSRCPTDT!element],
NULL as [Quantities!3!QTYRQSTN!element],
NULL as [Quantities!3!NXTCNTDT!element],
NULL as [Quantities!3!NXTCNTTM!element],
NULL as [Quantities!3!LSTCNTDT!element],
NULL as [Quantities!3!LSTCNTTM!element],
NULL as [Quantities!3!STCKCNTINTRVL!element],
NULL as [Quantities!3!Landed_Cost_Group_ID!element],
NULL as [Quantities!3!BUYERID!element],
NULL as [Quantities!3!PLANNERID!element],
NULL as [Quantities!3!ORDERPOLICY!element],
NULL as [Quantities!3!FXDORDRQTY!element],
NULL as [Quantities!3!ORDRPNTQTY!element],
NULL as [Quantities!3!NMBROFDYS!element],
NULL as [Quantities!3!MNMMORDRQTY!element],
NULL as [Quantities!3!MXMMORDRQTY!element],
NULL as [Quantities!3!ORDERMULTIPLE!element],
NULL as [Quantities!3!REPLENISHMENTMETHOD!element],
NULL as [Quantities!3!SHRINKAGEFACTOR!element],
NULL as [Quantities!3!PRCHSNGLDTM!element],
NULL as [Quantities!3!MNFCTRNGFXDLDTM!element],
NULL as [Quantities!3!MNFCTRNGVRBLLDTM!element],
NULL as [Quantities!3!STAGINGLDTME!element],
NULL as [Quantities!3!PLNNNGTMFNCDYS!element],
NULL as [Quantities!3!DMNDTMFNCPRDS!element],
NULL as [Quantities!3!INCLDDINPLNNNG!element],
NULL as [Quantities!3!CALCULATEATP!element],
NULL as [Quantities!3!AUTOCHKATP!element],
NULL as [Quantities!3!PLNFNLPAB!element],
NULL as [Quantities!3!FRCSTCNSMPTNPRD!element],
NULL as [Quantities!3!ORDRUPTOLVL!element],
NULL as [Quantities!3!SFTYSTCKQTY!element],
NULL as [Quantities!3!REORDERVARIANCE!element],
NULL as [Quantities!3!PORECEIPTBIN!element],
NULL as [Quantities!3!PORETRNBIN!element],
NULL as [Quantities!3!SOFULFILLMENTBIN!element],
NULL as [Quantities!3!SORETURNBIN!element],
NULL as [Quantities!3!BOMRCPTBIN!element],
NULL as [Quantities!3!MATERIALISSUEBIN!element],
NULL as [Quantities!3!MORECEIPTBIN!element],
NULL as [Quantities!3!REPAIRISSUESBIN!element],
NULL as [Quantities!3!ReplenishmentLevel!element],
NULL as [Quantities!3!POPOrderMethod!element],
NULL as [Quantities!3!POPPricingSelection!element],
NULL as [Quantities!3!PurchasePrice!element],
NULL as [Quantities!3!IncludeAllocations!element],
NULL as [Quantities!3!IncludeBackorders!element],
NULL as [Quantities!3!IncludeRequisitions!element] FROM [#eConnect_Out] [eConnect] (nolock) 
 UNION ALL Select 2,1,eConnect.ACTION,eConnect.DOCTYPE,
eConnect.DBNAME,
eConnect.TABLENAME,
eConnect.DATE1,
eConnect.INDEX1,
LTRIM(RTRIM([Item].ITEMNMBR)),
RTRIM([Item].ITEMDESC),RTRIM([Item].LOCNCODE),RTRIM([Item].ITMSHNAM),RTRIM([Item].ITEMTYPE),RTRIM([Item].ITMGEDSC),RTRIM([Item].ITMCLSCD),RTRIM([Item].STNDCOST),RTRIM([Item].CURRCOST),RTRIM([Item].ITEMSHWT),RTRIM([Item].USCATVLS_1),RTRIM([Item].USCATVLS_2),RTRIM([Item].USCATVLS_3),RTRIM([Item].USCATVLS_4),RTRIM([Item].USCATVLS_5),RTRIM([Item].USCATVLS_6),RTRIM([Item].ALTITEM1),RTRIM([Item].ALTITEM2),RTRIM([Item].WRNTYDYS),RTRIM([Item].ITEMCODE),RTRIM([Item].PRCHSUOM),RTRIM([Item].SELNGUOM),RTRIM([Item].KTACCTSR),RTRIM([Item].LASTGENSN),RTRIM([Item].ABCCODE),RTRIM([Item].NOTEINDX),RTRIM([Item].DECPLQTY),RTRIM([Item].DECPLCUR),RTRIM([Item].ITMTSHID),RTRIM([Item].TAXOPTNS),RTRIM([Item].IVIVINDX),RTRIM([Item].IVIVOFIX),RTRIM([Item].IVCOGSIX),RTRIM([Item].IVSLSIDX),RTRIM([Item].IVSLDSIX),RTRIM([Item].IVSLRNIX),RTRIM([Item].IVINUSIX),RTRIM([Item].IVINSVIX),RTRIM([Item].IVDMGIDX),RTRIM([Item].IVVARIDX),RTRIM([Item].DPSHPIDX),RTRIM([Item].PURPVIDX),RTRIM([Item].UPPVIDX),RTRIM([Item].IVRETIDX),RTRIM([Item].ASMVRIDX),RTRIM([Item].ITMTRKOP),RTRIM([Item].LOTTYPE),RTRIM([Item].KPERHIST),RTRIM([Item].KPTRXHST),RTRIM([Item].KPCALHST),RTRIM([Item].KPDSTHST),RTRIM([Item].ALWBKORD),RTRIM([Item].VCTNMTHD),RTRIM([Item].UOMSCHDL),RTRIM([Item].MSTRCDTY),[Item].MODIFDT,[Item].CREATDDT,RTRIM([Item].PRCLEVEL),RTRIM([Item].PINFLIDX),RTRIM([Item].PURMCIDX),RTRIM([Item].IVINFIDX),RTRIM([Item].INVMCIDX),RTRIM([Item].CGSINFLX),RTRIM([Item].CGSMCIDX),RTRIM([Item].TCC),RTRIM([Item].PriceGroup),RTRIM([Item].PRICMTHD),RTRIM([Item].Revalue_Inventory),RTRIM([Item].Tolerance_Percentage),RTRIM([Item].Purchase_Item_Tax_Schedu),RTRIM([Item].Purchase_Tax_Options),RTRIM([Item].ITMPLNNNGTYP),RTRIM([Item].STTSTCLVLPRCNTG),RTRIM([Item].CNTRYORGN),NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL FROM [#eConnect_Out] [eConnect] (nolock) 
 left outer join [IV00101] [Item] (nolock) on [Item].ITEMNMBR = eConnect.INDEX1 UNION ALL Select 3,2,eConnect.ACTION,eConnect.DOCTYPE,
eConnect.DBNAME,
eConnect.TABLENAME,
eConnect.DATE1,
eConnect.INDEX1,
LTRIM(RTRIM(Item.ITEMNMBR)),
NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,LTRIM(RTRIM([Quantities].ITEMNMBR)),
LTRIM(RTRIM([Quantities].RCRDTYPE)),
LTRIM(RTRIM([Quantities].LOCNCODE)),
RTRIM([Quantities].PRIMVNDR),RTRIM([Quantities].BGNGQTY),RTRIM([Quantities].LSORDQTY),RTRIM([Quantities].LRCPTQTY),[Quantities].LSTORDDT,RTRIM([Quantities].LSORDVND),RTRIM([Quantities].QTYONORD),RTRIM([Quantities].QTYBKORD),RTRIM([Quantities].QTY_Drop_Shipped),RTRIM([Quantities].QTYINUSE),RTRIM([Quantities].QTYINSVC),RTRIM([Quantities].QTYRTRND),RTRIM([Quantities].QTYDMGED),RTRIM([Quantities].QTYONHND),RTRIM([Quantities].ATYALLOC),RTRIM([Quantities].QTYCOMTD),RTRIM([Quantities].QTYSOLD),RTRIM([Quantities].BINNMBR),RTRIM([Quantities].ITMFRFLG),[Quantities].LSRCPTDT,RTRIM([Quantities].QTYRQSTN),[Quantities].NXTCNTDT,[Quantities].NXTCNTTM,[Quantities].LSTCNTDT,[Quantities].LSTCNTTM,RTRIM([Quantities].STCKCNTINTRVL),RTRIM([Quantities].Landed_Cost_Group_ID),RTRIM([Quantities].BUYERID),RTRIM([Quantities].PLANNERID),RTRIM([Quantities].ORDERPOLICY),RTRIM([Quantities].FXDORDRQTY),RTRIM([Quantities].ORDRPNTQTY),RTRIM([Quantities].NMBROFDYS),RTRIM([Quantities].MNMMORDRQTY),RTRIM([Quantities].MXMMORDRQTY),RTRIM([Quantities].ORDERMULTIPLE),RTRIM([Quantities].REPLENISHMENTMETHOD),RTRIM([Quantities].SHRINKAGEFACTOR),RTRIM([Quantities].PRCHSNGLDTM),RTRIM([Quantities].MNFCTRNGFXDLDTM),RTRIM([Quantities].MNFCTRNGVRBLLDTM),RTRIM([Quantities].STAGINGLDTME),RTRIM([Quantities].PLNNNGTMFNCDYS),RTRIM([Quantities].DMNDTMFNCPRDS),RTRIM([Quantities].INCLDDINPLNNNG),RTRIM([Quantities].CALCULATEATP),RTRIM([Quantities].AUTOCHKATP),RTRIM([Quantities].PLNFNLPAB),RTRIM([Quantities].FRCSTCNSMPTNPRD),RTRIM([Quantities].ORDRUPTOLVL),RTRIM([Quantities].SFTYSTCKQTY),RTRIM([Quantities].REORDERVARIANCE),RTRIM([Quantities].PORECEIPTBIN),RTRIM([Quantities].PORETRNBIN),RTRIM([Quantities].SOFULFILLMENTBIN),RTRIM([Quantities].SORETURNBIN),RTRIM([Quantities].BOMRCPTBIN),RTRIM([Quantities].MATERIALISSUEBIN),RTRIM([Quantities].MORECEIPTBIN),RTRIM([Quantities].REPAIRISSUESBIN),RTRIM([Quantities].ReplenishmentLevel),RTRIM([Quantities].POPOrderMethod),RTRIM([Quantities].POPPricingSelection),RTRIM([Quantities].PurchasePrice),RTRIM([Quantities].IncludeAllocations),RTRIM([Quantities].IncludeBackorders),RTRIM([Quantities].IncludeRequisitions) FROM [#eConnect_Out] [eConnect] (nolock) 
 left outer join [IV00101] [Item] (nolock) on [Item].ITEMNMBR = eConnect.INDEX1 left outer join [IV00102] [Quantities] (nolock) on Quantities.ITEMNMBR = Item.ITEMNMBR Order by  [eConnect!1!ITEMNMBR],  [Item!2!ITEMNMBR!element],Tag,Parent FOR XML EXPLICIT, BINARY BASE64
GO
GRANT EXECUTE ON  [dbo].[taRequesterItem2] TO [DYNGRP]
GO
