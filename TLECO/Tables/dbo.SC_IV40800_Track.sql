CREATE TABLE [dbo].[SC_IV40800_Track]
(
...
GO
ALTER TABLE [dbo].[SC_IV40800_Track] ADD CONSTRAINT [PK_SC_IV40800_Track] PRIMARY KEY CLUSTERED  ([Sequence]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_SC_IV40800_Track] ON [dbo].[SC_IV40800_Track] ([MapId], [Processed]) ON [PRIMARY]
GO
EXEC sp_bindefault N'[dbo].[GPS_DATE]', N'[dbo].[SC_IV40800_Track].[DateCreated]'
GO
EXEC sp_bindefault N'[dbo].[GPS_DATE]', N'[dbo].[SC_IV40800_Track].[DateProcessed]'
GO
GRANT REFERENCES ON  [dbo].[SC_IV40800_Track] TO [DYNGRP]
GO
GRANT SELECT ON  [dbo].[SC_IV40800_Track] TO [DYNGRP]
GO
GRANT INSERT ON  [dbo].[SC_IV40800_Track] TO [DYNGRP]
GO
GRANT DELETE ON  [dbo].[SC_IV40800_Track] TO [DYNGRP]
GO
GRANT UPDATE ON  [dbo].[SC_IV40800_Track] TO [DYNGRP]
GO
