...
[acct_code] [char] (66) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
[acct_type] [smallint] NULL,
[acct_status] [tinyint] NOT NULL,
[acct_desc] [char] (51) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
[normal_bal] [tinyint] NOT NULL,
[acct_group] [smallint] NOT NULL,
[nat_seg_code] [char] (66) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
GO
GRANT REFERENCES ON  [dbo].[frl_acct_code] TO [DYNGRP]
GO
GRANT SELECT ON  [dbo].[frl_acct_code] TO [DYNGRP]
GO
GRANT INSERT ON  [dbo].[frl_acct_code] TO [DYNGRP]
GO
GRANT DELETE ON  [dbo].[frl_acct_code] TO [DYNGRP]
GO
GRANT UPDATE ON  [dbo].[frl_acct_code] TO [DYNGRP]
GO
