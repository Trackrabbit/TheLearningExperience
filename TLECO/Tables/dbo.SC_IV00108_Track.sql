CREATE TABLE [dbo].[SC_IV00108_Track]
(
...
GO
ALTER TABLE [dbo].[SC_IV00108_Track] ADD CONSTRAINT [PK_SC_IV00108_Track] PRIMARY KEY CLUSTERED  ([Sequence]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IX_SC_IV00108_Track] ON [dbo].[SC_IV00108_Track] ([MapId], [Processed]) ON [PRIMARY]
GO
EXEC sp_bindefault N'[dbo].[GPS_DATE]', N'[dbo].[SC_IV00108_Track].[DateCreated]'
GO
EXEC sp_bindefault N'[dbo].[GPS_DATE]', N'[dbo].[SC_IV00108_Track].[DateProcessed]'
GO
GRANT REFERENCES ON  [dbo].[SC_IV00108_Track] TO [DYNGRP]
GO
GRANT SELECT ON  [dbo].[SC_IV00108_Track] TO [DYNGRP]
GO
GRANT INSERT ON  [dbo].[SC_IV00108_Track] TO [DYNGRP]
GO
GRANT DELETE ON  [dbo].[SC_IV00108_Track] TO [DYNGRP]
GO
GRANT UPDATE ON  [dbo].[SC_IV00108_Track] TO [DYNGRP]
GO
