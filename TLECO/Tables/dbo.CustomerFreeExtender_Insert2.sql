CREATE TABLE [dbo].[CustomerFreeExtender_Insert2]
(
...
GO
GRANT SELECT ON  [dbo].[CustomerFreeExtender_Insert2] TO [DYNGRP]
GO
GRANT INSERT ON  [dbo].[CustomerFreeExtender_Insert2] TO [DYNGRP]
GO
GRANT DELETE ON  [dbo].[CustomerFreeExtender_Insert2] TO [DYNGRP]
GO
GRANT UPDATE ON  [dbo].[CustomerFreeExtender_Insert2] TO [DYNGRP]
GO
