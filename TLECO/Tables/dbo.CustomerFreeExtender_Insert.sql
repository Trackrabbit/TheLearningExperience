CREATE TABLE [dbo].[CustomerFreeExtender_Insert]
(
...
GO
GRANT SELECT ON  [dbo].[CustomerFreeExtender_Insert] TO [DYNGRP]
GO
GRANT INSERT ON  [dbo].[CustomerFreeExtender_Insert] TO [DYNGRP]
GO
GRANT DELETE ON  [dbo].[CustomerFreeExtender_Insert] TO [DYNGRP]
GO
GRANT UPDATE ON  [dbo].[CustomerFreeExtender_Insert] TO [DYNGRP]
GO
