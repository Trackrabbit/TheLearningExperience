...
--select * from vw_de_PErollForwardByCenter
CREATE view [dbo].[vw_de_PErollForwardByCenter]
as

SELECT      'Beginning Balance Enrollments' as Line,  cc.tle_name,count(c.tle_childid) [Child Count],sum(c.tle_paymentamount) [Payment Amount]
...
union
SELECT      'Beginning Balance Returns' as Line,  cc.tle_name,count(c.tle_childid)*-1 [Child Count],sum(c.tle_paymentamount)*-1 [Payment Amount]
FROM           [TLEPROD_MSCRM].[dbo].[FilteredLead] L
...
SELECT       'current period enrollment' as Line, cc.tle_name,count(c.tle_childid) [Child Count],sum(c.tle_paymentamount) [Payment Amount]
FROM           [TLEPROD_MSCRM].[dbo].[FilteredLead] L
...
SELECT       'current period Returns' as Line, cc.tle_name,count(c.tle_childid)*-1 [Child Count],sum(c.tle_paymentamount)*-1 [Payment Amount]
FROM           [TLEPROD_MSCRM].[dbo].[FilteredLead] L
...
SELECT       'Current Period Centers Open Enrollment' as Line, cc.tle_name,count(c.tle_childid)*-1 [Child Count],sum(c.tle_paymentamount) [Payment Amount]
FROM           [TLEPROD_MSCRM].[dbo].[FilteredLead] L
...
union
SELECT       'Current Period Centers Open returns' as Line, cc.tle_name,count(c.tle_childid) [Child Count],sum(c.tle_paymentamount)*-1 [Payment Amount]
FROM           [TLEPROD_MSCRM].[dbo].[FilteredLead] L
...
group by cc.tle_name
GO
GRANT SELECT ON  [dbo].[vw_de_PErollForwardByCenter] TO [DYNGRP]
GO
GRANT INSERT ON  [dbo].[vw_de_PErollForwardByCenter] TO [DYNGRP]
GO
GRANT DELETE ON  [dbo].[vw_de_PErollForwardByCenter] TO [DYNGRP]
GO
GRANT UPDATE ON  [dbo].[vw_de_PErollForwardByCenter] TO [DYNGRP]
GO
