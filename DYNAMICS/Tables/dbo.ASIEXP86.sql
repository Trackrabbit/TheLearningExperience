...
GO
ALTER TABLE [dbo].[ASIEXP86] ADD CONSTRAINT [PKASIEXP86] PRIMARY KEY CLUSTERED  ([ASI_Favorite_Dict_ID], [ASI_Favorite_Type], [ASI_Favorite_Save_Level], [CMPANYID], [USRCLASS], [USERID], [ASI_Favorite_Name], [ASI_Field_Sequence]) ON [PRIMARY]
GO
